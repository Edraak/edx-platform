...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:
            db.delete_foreign_key("courseware_studentmodule", "student_id")
        except DatabaseError as db_err:
            print "Warning: {} -- if this is SQLite, this is expected.".format(db_err)

    def backwards(self, orm):
        raise RuntimeError("Cannot restore foreign key to students (it breaks sharding)")
    ...
    models = {
        ...
        'courseware.studentmodule': {
            'Meta': {'unique_together': "(('student_id', 'module_state_key', 'course_id'),)", 'object_name': 'StudentModule'},
            'course_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
