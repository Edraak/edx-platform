...
# For performing experiments on CSV-production times, set this higher:
# USER_COUNT = 10000
USER_COUNT = 11
...
class TestInstructorDashboardGradeDownloadCSV(ModuleStoreTestCase):
    ...
    def setUp(self):
        ...
        for user in self.users:
            ...
            # create grade entries in the OfflineTable that are realistic in size,
            # for the purposes of timing experiments as well as testing.
            gradeset = {"grade": None,
                        "totaled_scores": {
                        ...
                        "raw_scores": [[0, 1, True, "FoldIt challenge"], [0.0, 5.0, True, "Part IV"], [0.0, 10.0, True, "Part III"],
                                       ...
                                       [0.0, 5.0, True, "Biochemical Pathways, Part G"],
                                       [0.0, 5.0, True, "Biochemical Pathways, Part F"],
                                       [0.0, 5.0, True, "Biochemical Pathways, Part E"],
                                       [0.0, 5.0, True, "Biochemical Pathways, Part D"],
                                       [0.0, 5.0, True, "Biochemical Pathways, Part C"],
                                       [0.0, 5.0, True, "Biochemical Pathways, Part B"],
                                       [0.0, 5.0, True, "Biochemical Pathways, Part A"],
                                       [0.0, 5.0, True, "Enzymes"],
                                       [0.0, 5.0, True, "Proteins and Membranes, Part C"],
                                       [0.0, 5.0, True, "Proteins and Membranes, Part B"],
                                       [0.0, 5.0, True, "Proteins and Membranes, Part A"],
                                       [0.0, 5.0, True, "Designing Proteins in Two Dimensions, Part IV"],
                                       [0.0, 8.0, True, "Designing Proteins in Two Dimensions, Part III"],
                                       [0.0, 6.0, True, "Designing Proteins in Two Dimensions, Part II"],
                                       [0.0, 6.0, True, "Designing Proteins in Two Dimensions, Part I"],
                                       [0.0, 5.0, True, "Explore a Protein, Part E"],
                                       [0.0, 5.0, True, "Explore a Protein, Part D"],
                                       [0.0, 5.0, True, "Explore a Protein, Part C"],
                                       [0.0, 5.0, True, "Explore a Protein, Part B"],
                                       [0.0, 5.0, True, "Explore a Protein, Part A"],
                                       [0.0, 10.0, True, "Problem 17, VGL 6: Two Genes and Linkage"],
                                       [0.0, 10.0, True, "Problem 16, VGL 5: Two Genes and Simple Dominance"],
                                       [0.0, 4.0, True, "Problem 15, VGL 4: Sex Linkage II"],
                                       [0.0, 4.0, True, "Problem 14, VGL 3: Sex Linkage"],
                                       [0.0, 3.0, True, "Problem 13, VGL 2: Incomplete Dominance"],
                                       [0.0, 3.0, True, "Problem 12, VGL 1: Simple Dominance"],
                                       [0.0, 6.0, True, "Problem 11, Recombination Maps"],
                                       [0.0, 6.0, True, "Problem 10, Flies II"],
                                       [0.0, 6.0, True, "Problem 09b, Flies, Part B"],
                                       [0.0, 6.0, True, "Problem 09a, Flies, Part A"],
                                       [0.0, 6.0, True, "Problem 08, Peas IV"],
                                       [0.0, 9.0, True, "Problem 07, Peas III"],
                                       [0.0, 6.0, True, "Problem 06, Rats IV"],
                                       [0.0, 3.0, True, "Problem 05, Rats III"],
                                       [0.0, 6.0, True, "Problem 04, Peas II"],
                                       [0.0, 6.0, True, "Problem 03, Peas I"],
                                       [0.0, 3.0, True, "Problem 02, Rats II"],
                                       [0.0, 3.0, True, "Problem 01, Rats I"],
                                       [0.0, 5.0, True, "Edit a Gene Part E"],
                                       [0.0, 5.0, True, "Edit a Gene Part D"],
                                       [0.0, 5.0, True, "Edit a Gene Part C"],
                                       [0.0, 5.0, True, "Edit a Gene Part B"],
                                       [0.0, 5.0, True, "Edit a Gene Part A"],
                                       [0.0, 10.0, True, "Explore A Gene, Part E"],
                                       [0.0, 10.0, True, "Explore A Gene, Part D"],
                                       [0.0, 10.0, True, "Explore A Gene, Part C"],
                                       [0.0, 5.0, True, "Explore A Gene, Part B"],
                                       [0.0, 5.0, True, "Explore A Gene, Part A"],
                                       [2.5, 5.0, True, "A Small Gene, Part E"],
                                       [0.0, 5.0, True, "A Small Gene, Part D"],
                                       [2.5, 5.0, True, "A Small Gene, Part C"],
                                       [2.5, 5.0, True, "A Small Gene, Part B"],
                                       [0.0, 5.0, True, "A Small Gene, Part A"],
                                       [3.75, 5.0, True, "DNA Replication"],
                                       [2.5, 5.0, True, "Chargaff\u2019s Ratios"],
                                       [0.0, 10.0, True, "Problem 08, Task 4: Create a translational fusion protein"],
                                       [0.0, 10.0, True, "Problem 07, Build a Plasmid, Part C"],
                                       [0.0, 10.0, True, "Problem 07, Build a Plasmid, Part B"],
                                       [0.0, 10.0, True, "Problem 07, Build a Plasmid, Part A"],
                                       [0.0, 10.0, True, "Problem 06, DNA Sequencing"],
                                       [0.0, 10.0, True, "Problem 05, Genotyping Using PCR and Restriction Enzymes, Part B"],
                                       [0.0, 10.0, True, "Problem 05, Genotyping Using PCR and Restriction Enzymes, Part A"],
                                       [0.0, 5.0, True, "Problem 04, Plasmids"],
                                       [0.0, 10.0, True, "Problem 03, Polymerase Chain Reaction (PCR)"],
                                       [0.0, 5.0, True, "Problem 02, DNA Electrophoresis, Part B"],
                                       [0.0, 5.0, True, "Problem 02, DNA Electrophoresis, Part A"],
                                       [0.0, 5.0, True, "Problem 01, Restriction Enzymes"],
                                       [0.0, 10.0, True, "Population Genetics"],
                                       [0.0, 5.0, True, "Biochemical Genetics, Part 2"],
                                       [0.0, 5.0, True, "Biochemical Genetics, Part 1"],
                                       [0.0, 10.0, True, "Pedigrees II, Part D"],
                                       [0.0, 10.0, True, "Pedigrees II, Part C"],
                                       [0.0, 10.0, True, "Pedigrees II, Part B"],
                                       [0.0, 10.0, True, "Pedigrees II, Part A"],
                                       [0.0, 10.0, True, "Pedigrees I, Part D"],
                                       [0.0, 10.0, True, "Pedigrees I, Part C"],
                                       [0.0, 10.0, True, "Pedigrees I, Part B"],
                                       [0.0, 10.0, True, "Pedigrees I, Part A"],
                                       [0.0, 7.0, True, "Problem 07, Chicken Genetics, Part D"],
                                       [0.0, 7.0, True, "Problem 07, Chicken Genetics, Part C"],
                                       [0.0, 5.0, True, "Problem 07, Chicken Genetics, Part B"],
                                       [0.0, 5.0, True, "Problem 07, Chicken Genetics, Part A"],
                                       [0.0, 7.0, True, "Problem 06, Pedigrees II"],
                                       [0.0, 7.0, True, "Problem 05, Pedigrees, Part D"],
                                       [0.0, 7.0, True, "Problem 05, Pedigrees, Part C"],
                                       [0.0, 7.0, True, "Problem 05, Pedigrees, Part B"],
                                       [0.0, 7.0, True, "Problem 05, Pedigrees, Part A"],
                                       [0.0, 5.0, True, "Problem 04, Pathways, Part C"],
                                       [0.0, 5.0, True, "Problem 04, Pathways, Part B"],
                                       [0.0, 5.0, True, "Problem 04, Pathways, Part A"],
                                       [0.0, 5.0, True, "Problem 03, Free Energy"],
                                       [0.0, 5.0, True, "Problem 02, Explore a Protein, Part C"],
                                       [0.0, 5.0, True, "Problem 02, Explore a Protein, Part B"],
                                       [0.0, 5.0, True, "Problem 02, Explore a Protein, Part A"],
                                       [0.0, 5.0, True, "Problem 01, Edit a Molecule, Part C"],
                                       [0.0, 5.0, True, "Problem 01, Edit a Molecule, Part B"],
                                       [0.0, 5.0, True, "Problem 01, Edit a Molecule, Part A"]],
    ...
    def test_download_grades_csv(self):
        ...
        # endtime = time()
        # print("Duration for {} users: {} secs".format(USER_COUNT, (endtime - starttime)))
        # For testing, enable this to look at debug info:
        ...
        # TODO: need to slice out the grade update-date column from the comparison
