...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QueryableLog'
        db.create_table('queryable_queryablelog', (
        ...
        db.send_create_signal('queryable', ['QueryableLog'])

        # Adding unique constraint on 'QueryableLog', fields ['script_id', 'course_id']
        db.create_unique('queryable_queryablelog', ['script_id', 'course_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'QueryableLog', fields ['script_id', 'course_id']
        db.delete_unique('queryable_queryablelog', ['script_id', 'course_id'])

        # Deleting model 'QueryableLog'
        db.delete_table('queryable_queryablelog')
    ...
    models = {
        ...
        'queryable.queryablelog': {
            'Meta': {'unique_together': "(('script_id', 'course_id'),)", 'object_name': 'QueryableLog'},
            'course_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
