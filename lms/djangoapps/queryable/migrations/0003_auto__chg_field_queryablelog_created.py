...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QueryableLog.created'
        db.alter_column('queryable_queryablelog', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'QueryableLog.created'
        db.alter_column('queryable_queryablelog', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
    ...
    models = {
        ...
        'queryable.queryablelog': {
            'Meta': {'ordering': "['-created']", 'unique_together': "(('script_id', 'course_id'),)", 'object_name': 'QueryableLog'},
            'course_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
