...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'StudentGrades', fields ['user', 'course_id', 'label']
        db.delete_unique('queryable_studentgrades', ['user_id', 'course_id', 'label'])

        # Deleting model 'StudentGrades'
        db.delete_table('queryable_studentgrades')
        ...
        db.create_table('queryable_assignmenttypegrade', (
            ...
            ('percent', self.gf('django.db.models.fields.FloatField')(db_index=True)),
        ...
        db.create_table('queryable_coursegrade', (
            ...
            ('course_id', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('percent', self.gf('django.db.models.fields.FloatField')(db_index=True)),
            ('grade', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, db_index=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.create_table('queryable_studentgrades', (
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True, db_index=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('course_id', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('level', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True, db_index=True)),
            ('percent', self.gf('django.db.models.fields.FloatField')(db_index=True)),
            ('detail', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
        ))
        db.send_create_signal('queryable', ['StudentGrades'])

        # Adding unique constraint on 'StudentGrades', fields ['user', 'course_id', 'label']
        db.create_unique('queryable_studentgrades', ['user_id', 'course_id', 'label'])
    ...
    models = {
        ...
        'queryable.coursegrade': {
            ...
            'course_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'grade': ('django.db.models.fields.CharField', [], {'max_length': '32', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'percent': ('django.db.models.fields.FloatField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
