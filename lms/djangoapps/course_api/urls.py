...
from .views import (
    CourseDetailView, CourseListView, MarketingCourseDetailView, SpecializationCourseListView
)
...
urlpatterns = patterns(
    ...
    url(r'^v1/(?P<specialization_slug>{})/$'.format(settings.SPECIALIZATION_SLUG_RGX), SpecializationCourseListView.as_view(), name="spec-course-list"),
