...
BAYT_API_BASE = ENV_TOKENS.get("BAYT_API_BASE")

# Edraak and KAFD/ForUs integration.
FORUS_SECRET_KEY = AUTH_TOKENS.get("FORUS_SECRET_KEY")
FORUS_API_BASE = ENV_TOKENS.get("FORUS_API_BASE")
FORUS_ERROR_REDIRECT_URL = ENV_TOKENS.get("FORUS_ERROR_REDIRECT_URL")
FORUS_JOBS_BASE = ENV_TOKENS.get("FORUS_JOBS_BASE")
