...
# How many times the user is allowed to change their names before the changes are being sent for review?
ALLOWED_QUICK_NAME_CHANGE = ENV_TOKENS.get("ALLOWED_QUICK_NAME_CHANGE", 3)
