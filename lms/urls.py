...
urlpatterns = ('',  # nopep8
    ...
    # Themed instances don't need/want many of these routes.
    ...
    # Add in the routes that the theme needs
    url(r'^about$', 'static_template_view.views.render',
        {'template': 'theme-about.html'}, name="about_edx"),
    url(r'^tos$', 'static_template_view.views.render',
        {'template': 'theme-tos.html'}, name="tos"), 
