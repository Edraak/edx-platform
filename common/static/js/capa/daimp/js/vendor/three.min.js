...
e=THREE.Matrix4.__v1,f=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();0===g.length()&&(g.z=1);e.cross(c,g).normalize();0===e.length()&&(g.x+=1E-4,e.cross(c,g).normalize());f.cross(g,e);d[0]=e.x;d[4]=f.x;d[8]=g.x;d[1]=e.y;d[5]=f.y;d[9]=g.y;d[2]=e.z;d[6]=f.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,e=this.elements,f=c[0],g=c[4],h=c[8],i=c[12],j=c[1],l=c[5],m=c[9],n=c[13],p=c[2],o=c[6],q=c[10],t=c[14],s=c[3],z=c[7],w=c[11],c=c[15],r=d[0],E=d[4],A=d[8],
v=d[12],u=d[1],D=d[5],C=d[9],G=d[13],P=d[2],B=d[6],K=d[10],H=d[14],I=d[3],N=d[7],O=d[11],d=d[15];e[0]=f*r+g*u+h*P+i*I;e[4]=f*E+g*D+h*B+i*N;e[8]=f*A+g*C+h*K+i*O;e[12]=f*v+g*G+h*H+i*d;e[1]=j*r+l*u+m*P+n*I;e[5]=j*E+l*D+m*B+n*N;e[9]=j*A+l*C+m*K+n*O;e[13]=j*v+l*G+m*H+n*d;e[2]=p*r+o*u+q*P+t*I;e[6]=p*E+o*D+q*B+t*N;e[10]=p*A+o*C+q*K+t*O;e[14]=p*v+o*G+q*H+t*d;e[3]=s*r+z*u+w*P+c*I;e[7]=s*E+z*D+w*B+c*N;e[11]=s*A+z*C+w*K+c*O;e[15]=s*v+z*G+w*H+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,i=f*f,j=Math.cos(b),l=Math.sin(b),m=1-j,n=d*e*m,p=d*f*m,m=e*f*m,d=d*l,o=e*l,l=f*l,f=g+(1-g)*j,g=n+l,e=p-o,n=n-l,h=h+(1-h)*j,l=m+d,p=p+o,m=m-d,i=i+(1-i)*j,j=c[0],d=c[1],o=c[2],q=c[3],t=c[4],s=c[5],z=c[6],w=c[7],r=c[8],E=c[9],A=c[10],v=c[11];c[0]=f*j+g*t+e*r;c[1]=f*d+g*s+e*E;c[2]=f*o+g*z+e*A;c[3]=f*q+g*w+e*v;c[4]=n*j+h*t+l*r;c[5]=n*d+h*s+l*E;c[6]=n*o+h*z+l*A;c[7]=n*q+h*w+l*v;c[8]=p*j+m*t+i*r;c[9]=p*d+m*s+i*E;c[10]=p*o+m*z+i*A;c[11]=p*q+m*w+i*v;
...
e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,u){h=a.vertices[b];i=a.vertices[c];j=a.vertices[d];l=g[e];m=g[f];n=g[u];p=i.x-h.x;o=j.x-h.x;q=i.y-h.y;t=j.y-h.y;s=i.z-h.z;z=j.z-h.z;w=m.u-l.u;r=n.u-l.u;E=m.v-l.v;A=n.v-l.v;v=1/(w*A-r*E);G.set((A*p-E*o)*v,(A*q-E*t)*v,(A*s-E*z)*v);P.set((w*o-r*p)*v,(w*t-r*q)*v,(w*z-r*s)*v);D[b].addSelf(G);D[c].addSelf(G);D[d].addSelf(G);C[b].addSelf(P);C[c].addSelf(P);C[d].addSelf(P)}var b,c,d,e,f,g,h,i,j,l,m,n,p,o,q,t,s,z,
w,r,E,A,v,u,D=[],C=[],G=new THREE.Vector3,P=new THREE.Vector3,B=new THREE.Vector3,K=new THREE.Vector3,H=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)D[b]=new THREE.Vector3,C[b]=new THREE.Vector3;b=0;for(c=this.faces.length;b<c;b++)f=this.faces[b],g=this.faceVertexUvs[0][b],f instanceof THREE.Face3?a(this,f.a,f.b,f.c,0,1,2):f instanceof THREE.Face4&&(a(this,f.a,f.b,f.d,0,1,3),a(this,f.b,f.c,f.d,1,2,3));var I=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){f=this.faces[b];for(d=0;d<
...
4*f;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var l,m,n,p,o,q,t,s,z,w,r,E,A,v,u,f=new THREE.Vector3,g=new THREE.Vector3,D,C,G,P,B,K,H,I=this.offsets;G=0;for(P=I.length;G<P;++G){C=I[G].start;B=I[G].count;var N=I[G].index;D=C;for(C+=B;D<C;D+=3)B=N+b[D],K=N+b[D+1],H=N+b[D+2],l=c[3*B],m=c[3*B+1],n=c[3*B+2],p=c[3*K],o=c[3*K+1],q=c[3*K+2],t=c[3*H],s=c[3*H+1],z=c[3*
H+2],w=e[2*B],r=e[2*B+1],E=e[2*K],A=e[2*K+1],v=e[2*H],u=e[2*H+1],p-=l,l=t-l,o-=m,m=s-m,q-=n,n=z-n,E-=w,w=v-w,A-=r,r=u-r,u=1/(E*r-w*A),f.set((r*p-A*l)*u,(r*o-A*m)*u,(r*q-A*n)*u),g.set((E*l-w*p)*u,(E*m-w*o)*u,(E*n-w*q)*u),i[B].addSelf(f),i[K].addSelf(f),i[H].addSelf(f),j[B].addSelf(g),j[K].addSelf(g),j[H].addSelf(g)}var O=new THREE.Vector3,R=new THREE.Vector3,ga=new THREE.Vector3,M=new THREE.Vector3,J,Q,Z;G=0;for(P=I.length;G<P;++G){C=I[G].start;B=I[G].count;N=I[G].index;D=C;for(C+=B;D<C;D+=3)B=N+b[D],
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(){var b,c,d,e,j,l,m,n,p,o,q,t,s,z,w,r;function E(a){return a%4?4-a%4:0}function A(a,b){return(new Uint8Array(a,b,1))[0]}function v(a,b){return(new Uint32Array(a,b,1))[0]}function u(b,c){var d,e,f,g,h,i,j,l=new Uint32Array(a,c,3*b);for(d=0;d<b;d++)e=l[3*d],f=l[3*d+1],g=l[3*d+2],h=N[2*e],e=N[2*e+1],i=N[2*f],j=N[2*f+1],f=N[2*g],g=N[2*g+1],K.faceVertexUvs[0].push([new THREE.UV(h,e),new THREE.UV(i,j),new THREE.UV(f,g)])}function D(b,
...
f,g,h,i,c=new Uint32Array(a,c,4*b),j=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[4*d],f=c[4*d+1],g=c[4*d+2],h=c[4*d+3],i=j[d],K.faces.push(new THREE.Face4(e,f,g,h,null,null,i))}function P(b,c,d,e){for(var f,g,h,i,j,l,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[3*e];g=c[3*e+1];h=c[3*e+2];j=d[3*e];l=d[3*e+1];n=d[3*e+2];i=m[e];var o=I[3*l],p=I[3*l+1];l=I[3*l+2];var r=I[3*n],q=I[3*n+1];n=I[3*n+2];K.faces.push(new THREE.Face3(f,g,h,[new THREE.Vector3(I[3*
j],I[3*j+1],I[3*j+2]),new THREE.Vector3(o,p,l),new THREE.Vector3(r,q,n)],null,i))}}function B(b,c,d,e){for(var f,g,h,i,j,l,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];l=d[4*e];n=d[4*e+1];m=d[4*e+2];o=d[4*e+3];j=p[e];var r=I[3*n],q=I[3*n+1];n=I[3*n+2];var s=I[3*m],t=I[3*m+1];m=I[3*m+2];var u=I[3*o],v=I[3*o+1];o=I[3*o+2];K.faces.push(new THREE.Face4(f,g,h,i,[new THREE.Vector3(I[3*l],I[3*l+1],I[3*l+2]),new THREE.Vector3(r,
q,n),new THREE.Vector3(s,t,m),new THREE.Vector3(u,v,o)],null,j))}}var K=this,H=0,I=[],N=[],O,R,ga;THREE.Geometry.call(this);r=a;R=H;z=new Uint8Array(r,R,12);o="";for(s=0;12>s;s++)o+=String.fromCharCode(z[R+s]);b=A(r,R+12);A(r,R+13);A(r,R+14);A(r,R+15);c=A(r,R+16);d=A(r,R+17);e=A(r,R+18);j=A(r,R+19);l=v(r,R+20);m=v(r,R+20+4);n=v(r,R+20+8);p=v(r,R+20+12);o=v(r,R+20+16);q=v(r,R+20+20);t=v(r,R+20+24);s=v(r,R+20+28);z=v(r,R+20+32);w=v(r,R+20+36);r=v(r,R+20+40);H+=b;R=3*c+j;ga=4*c+j;O=p*R;b=o*(R+3*d);c=
q*(R+3*e);j=t*(R+3*d+3*e);R=s*ga;d=z*(ga+4*d);e=w*(ga+4*e);ga=H;var H=new Float32Array(a,H,3*l),M,J,Q,Z;for(M=0;M<l;M++)J=H[3*M],Q=H[3*M+1],Z=H[3*M+2],K.vertices.push(new THREE.Vector3(J,Q,Z));l=H=ga+3*l*Float32Array.BYTES_PER_ELEMENT;if(m){H=new Int8Array(a,H,3*m);for(ga=0;ga<m;ga++)M=H[3*ga],J=H[3*ga+1],Q=H[3*ga+2],I.push(M/127,J/127,Q/127)}H=l+3*m*Int8Array.BYTES_PER_ELEMENT;m=H+=E(3*m);if(n){l=new Float32Array(a,H,2*n);for(H=0;H<n;H++)ga=l[2*H],M=l[2*H+1],N.push(ga,M)}n=H=m+2*n*Float32Array.BYTES_PER_ELEMENT;
O=n+O+E(2*p);m=O+b+E(2*o);b=m+c+E(2*q);c=b+j+E(2*t);R=c+R+E(2*s);j=R+d+E(2*z);d=j+e+E(2*w);q&&(e=m+3*q*Uint32Array.BYTES_PER_ELEMENT,C(q,m,e+3*q*Uint32Array.BYTES_PER_ELEMENT),u(q,e));t&&(q=b+3*t*Uint32Array.BYTES_PER_ELEMENT,e=q+3*t*Uint32Array.BYTES_PER_ELEMENT,P(t,b,q,e+3*t*Uint32Array.BYTES_PER_ELEMENT),u(t,e));w&&(t=j+4*w*Uint32Array.BYTES_PER_ELEMENT,G(w,j,t+4*w*Uint32Array.BYTES_PER_ELEMENT),D(w,t));r&&(w=d+4*r*Uint32Array.BYTES_PER_ELEMENT,t=w+4*r*Uint32Array.BYTES_PER_ELEMENT,B(r,d,w,t+4*
r*Uint32Array.BYTES_PER_ELEMENT),D(r,t));p&&C(p,n,n+3*p*Uint32Array.BYTES_PER_ELEMENT);o&&(p=O+3*o*Uint32Array.BYTES_PER_ELEMENT,P(o,O,p,p+3*o*Uint32Array.BYTES_PER_ELEMENT));s&&G(s,c,c+4*s*Uint32Array.BYTES_PER_ELEMENT);z&&(o=R+4*z*Uint32Array.BYTES_PER_ELEMENT,B(z,R,o,o+4*z*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals()};e.prototype=Object.create(THREE.Geometry.prototype);e=new e(c);c=this.initMaterials(d,c);this.needsTangents(c)&&e.computeTangents();b(e,c)};
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1,f,g,h,i,j,l,m,n,p,o,q,t,s,z,w,r=a.faces;o=a.vertices;var E=a.normals,A=a.colors,v=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&v++;for(f=0;f<v;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];i=0;for(j=o.length;i<j;)l=new THREE.Vector3,l.x=o[i++]*e,l.y=o[i++]*e,l.z=o[i++]*e,d.vertices.push(l);i=0;for(j=r.length;i<j;){o=r[i++];l=o&1;h=o&2;f=o&4;g=o&8;n=o&16;m=o&32;q=o&64;o&=128;l?(t=new THREE.Face4,
t.a=r[i++],t.b=r[i++],t.c=r[i++],t.d=r[i++],l=4):(t=new THREE.Face3,t.a=r[i++],t.b=r[i++],t.c=r[i++],l=3);h&&(h=r[i++],t.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<v;f++)s=a.uvs[f],p=r[i++],w=s[2*p],p=s[2*p+1],d.faceUvs[f][h]=new THREE.UV(w,p);if(g)for(f=0;f<v;f++){s=a.uvs[f];z=[];for(g=0;g<l;g++)p=r[i++],w=s[2*p],p=s[2*p+1],z[g]=new THREE.UV(w,p);d.faceVertexUvs[f][h]=z}n&&(n=3*r[i++],g=new THREE.Vector3,g.x=E[n++],g.y=E[n++],g.z=E[n],t.normal=g);if(m)for(f=0;f<l;f++)n=3*r[i++],g=new THREE.Vector3,
g.x=E[n++],g.y=E[n++],g.z=E[n],t.vertexNormals.push(g);q&&(m=r[i++],m=new THREE.Color(A[m]),t.color=m);if(o)for(f=0;f<l;f++)m=r[i++],m=new THREE.Color(A[m]),t.vertexColors.push(m);d.faces.push(t)}if(a.skinWeights){i=0;for(j=a.skinWeights.length;i<j;i+=2)r=a.skinWeights[i],E=a.skinWeights[i+1],d.skinWeights.push(new THREE.Vector4(r,E,0,0))}if(a.skinIndices){i=0;for(j=a.skinIndices.length;i<j;i+=2)r=a.skinIndices[i],E=a.skinIndices[i+1],d.skinIndices.push(new THREE.Vector4(r,E,0,0))}d.bones=a.bones;
...
E=d.morphColors[i].colors;A=a.morphColors[i].colors;e=0;for(r=A.length;e<r;e+=3)v=new THREE.Color(16755200),v.setRGB(A[e],A[e+1],A[e+2]),E.push(v)}}d.computeCentroids();d.computeFaceNormals();a=this.initMaterials(a.materials,c);this.needsTangents(a)&&d.computeTangents();b(d,a)};
...
n.options?n.load(d(e.url,Q.urlBaseType),h(c,a,C,e)):n.load(d(e.url,Q.urlBaseType),h(c,a,C,e),i)}else if(void 0!==e.geometry){if(D=M.geometries[e.geometry]){g=!1;C=M.materials[e.material];g=C instanceof THREE.ShaderMaterial;w=e.position;r=e.rotation;E=e.quaternion;A=e.scale;s=e.matrix;E=0;e.material||(C=new THREE.MeshFaceMaterial(M.face_materials[e.geometry]));C instanceof THREE.MeshFaceMaterial&&0===C.materials.length&&(C=new THREE.MeshFaceMaterial(M.face_materials[e.geometry]));if(C instanceof THREE.MeshFaceMaterial)for(i=
...
s[15])):(g.position.set(w[0],w[1],w[2]),E?(g.quaternion.set(E[0],E[1],E[2],E[3]),g.useQuaternion=!0):g.rotation.set(r[0],r[1],r[2]),g.scale.set(A[0],A[1],A[2]));g.visible=e.visible;g.castShadow=e.castShadow;g.receiveShadow=e.receiveShadow;a.add(g);M.objects[c]=g}}else"DirectionalLight"===e.type||"PointLight"===e.type||"AmbientLight"===e.type?(H=void 0!==e.color?e.color:16777215,I=void 0!==e.intensity?e.intensity:1,"DirectionalLight"===e.type?(w=e.direction,K=new THREE.DirectionalLight(H,I),K.position.set(w[0],
...
v.right,v.top,v.bottom,v.near,v.far)),w=e.position,G.position.set(w[0],w[1],w[2]),a.add(G),G.name=c,M.cameras[c]=G,M.objects[c]=G):(w=e.position,r=e.rotation,E=e.quaternion,A=e.scale,E=0,g=new THREE.Object3D,g.name=c,g.position.set(w[0],w[1],w[2]),E?(g.quaternion.set(E[0],E[1],E[2],E[3]),g.useQuaternion=!0):g.rotation.set(r[0],r[1],r[2]),g.scale.set(A[0],A[1],A[2]),g.visible=void 0!==e.visible?e.visible:!1,a.add(g),M.objects[c]=g,M.empties[c]=g);if(g){if(void 0!==e.properties)for(var m in e.properties)g.properties[m]=
...
Q.urlBaseType),g(n),L)}else"embedded"===t.type&&(L=Q.embeds[t.id],L.metadata=Q.metadata,L&&this.geometryHandlerMap.ascii.loaderObject.createModel(L,i(n),""));for(q in Q.textures)if(n=Q.textures[q],n.url instanceof Array){O+=n.url.length;for(B=0;B<n.url.length;B++)l.onLoadStart()}else O+=1,l.onLoadStart();ga=O;for(q in Q.textures){n=Q.textures[q];void 0!==n.mapping&&void 0!==THREE[n.mapping]&&(n.mapping=new THREE[n.mapping]);if(n.url instanceof Array){L=n.url.length;o=[];for(B=0;B<L;B++)o[B]=d(n.url[B],
...
(B.repeat.set(n.repeat[0],n.repeat[1]),1!==n.repeat[0]&&(B.wrapS=THREE.RepeatWrapping),1!==n.repeat[1]))B.wrapT=THREE.RepeatWrapping;n.offset&&B.offset.set(n.offset[0],n.offset[1]);if(n.wrap&&(L={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},void 0!==L[n.wrap[0]]&&(B.wrapS=L[n.wrap[0]]),void 0!==L[n.wrap[1]]))B.wrapT=L[n.wrap[1]]}M.textures[q]=B}for(p in Q.materials){s=Q.materials[p];for(u in s.parameters)"envMap"===u||"map"===u||"lightMap"===u||"bumpMap"===u?s.parameters[u]=M.textures[s.parameters[u]]:
"shading"===u?s.parameters[u]="flat"===s.parameters[u]?THREE.FlatShading:THREE.SmoothShading:"side"===u?s.parameters[u]="double"==s.parameters[u]?THREE.DoubleSide:"back"==s.parameters[u]?THREE.BackSide:THREE.FrontSide:"blending"===u?s.parameters[u]=s.parameters[u]in THREE?THREE[s.parameters[u]]:THREE.NormalBlending:"combine"===u?s.parameters[u]="MixOperation"==s.parameters[u]?THREE.MixOperation:THREE.MultiplyOperation:"vertexColors"===u?"face"==s.parameters[u]?s.parameters[u]=THREE.FaceColors:s.parameters[u]&&
(s.parameters[u]=THREE.VertexColors):"wrapRGB"===u&&(q=s.parameters[u],s.parameters[u]=new THREE.Vector3(q[0],q[1],q[2]));void 0!==s.parameters.opacity&&1>s.parameters.opacity&&(s.parameters.transparent=!0);s.parameters.normalMap?(q=THREE.ShaderUtils.lib.normal,Z=THREE.UniformsUtils.clone(q.uniforms),n=s.parameters.color,B=s.parameters.specular,L=s.parameters.ambient,o=s.parameters.shininess,Z.tNormal.value=M.textures[s.parameters.normalMap],s.parameters.normalScale&&Z.uNormalScale.value.set(s.parameters.normalScale[0],
s.parameters.normalScale[1]),s.parameters.map&&(Z.tDiffuse.value=s.parameters.map,Z.enableDiffuse.value=!0),s.parameters.envMap&&(Z.tCube.value=s.parameters.envMap,Z.enableReflection.value=!0,Z.uReflectivity.value=s.parameters.reflectivity),s.parameters.lightMap&&(Z.tAO.value=s.parameters.lightMap,Z.enableAO.value=!0),s.parameters.specularMap&&(Z.tSpecular.value=M.textures[s.parameters.specularMap],Z.enableSpecular.value=!0),s.parameters.displacementMap&&(Z.tDisplacement.value=M.textures[s.parameters.displacementMap],
Z.enableDisplacement.value=!0,Z.uDisplacementBias.value=s.parameters.displacementBias,Z.uDisplacementScale.value=s.parameters.displacementScale),Z.uDiffuseColor.value.setHex(n),Z.uSpecularColor.value.setHex(B),Z.uAmbientColor.value.setHex(L),Z.uShininess.value=o,s.parameters.opacity&&(Z.uOpacity.value=s.parameters.opacity),C=new THREE.ShaderMaterial({fragmentShader:q.fragmentShader,vertexShader:q.vertexShader,uniforms:Z,lights:!0,fog:!0})):C=new THREE[s.type](s.parameters);M.materials[p]=C}for(p in Q.materials)if(s=
Q.materials[p],s.parameters.materials){u=[];for(B=0;B<s.parameters.materials.length;B++)u.push(M.materials[s.parameters.materials[B]]);M.materials[p].materials=u}e();M.cameras&&Q.defaults.camera&&(M.currentCamera=M.cameras[Q.defaults.camera]);M.fogs&&Q.defaults.fog&&(M.scene.fog=M.fogs[Q.defaults.fog]);v=Q.defaults.bgcolor;M.bgColor=new THREE.Color;M.bgColor.setRGB(v[0],v[1],v[2]);M.bgColorAlpha=Q.defaults.bgalpha;l.callbackSync(M);j()};
...
THREE.CanvasRenderer=function(a){function b(a){z!==a&&(z=q.globalAlpha=a)}function c(a){w!==a&&(a===THREE.NormalBlending?q.globalCompositeOperation="source-over":a===THREE.AdditiveBlending?q.globalCompositeOperation="lighter":a===THREE.SubtractiveBlending&&(q.globalCompositeOperation="darker"),w=a)}function d(a){r!==a&&(r=q.strokeStyle=a)}function e(a){E!==a&&(E=q.fillStyle=a)}console.log("THREE.CanvasRenderer",THREE.REVISION);var a=a||{},f=this,g,h,i,j=new THREE.Projector,l=void 0!==a.canvas?a.canvas:
document.createElement("canvas"),m,n,p,o,q=l.getContext("2d"),t=new THREE.Color(0),s=0,z=1,w=0,r=null,E=null,A=null,v=null,u=null,D,C,G,P,B=new THREE.RenderableVertex,K=new THREE.RenderableVertex,H,I,N,O,R,ga,M,J,Q,Z,L,oa,X=new THREE.Color,fa=new THREE.Color,ca=new THREE.Color,Y=new THREE.Color,ba=new THREE.Color,aa=new THREE.Color,ia=new THREE.Color,Aa={},Na={},Ja,ma,sa,Ea,qb,hb,nb,ib,Bb,Cb,Wa=new THREE.Rectangle,Sa=new THREE.Rectangle,Ka=new THREE.Rectangle,jb=!1,Oa=new THREE.Color,kb=new THREE.Color,
ab=new THREE.Color,va=new THREE.Vector3,db,ob,bb,xa,lb,rb,a=16;db=document.createElement("canvas");db.width=db.height=2;ob=db.getContext("2d");ob.fillStyle="rgba(0,0,0,1)";ob.fillRect(0,0,2,2);bb=ob.getImageData(0,0,2,2);xa=bb.data;lb=document.createElement("canvas");lb.width=lb.height=a;rb=lb.getContext("2d");rb.translate(-a/2,-a/2);rb.scale(a,a);a--;this.domElement=l;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){m=a;n=b;p=
Math.floor(m/2);o=Math.floor(n/2);l.width=m;l.height=n;Wa.set(-p,-o,p,o);Sa.set(-p,-o,p,o);z=1;w=0;u=v=A=E=r=null};this.setClearColor=function(a,b){t.copy(a);s=void 0!==b?b:1;Sa.set(-p,-o,p,o)};this.setClearColorHex=function(a,b){t.setHex(a);s=void 0!==b?b:1;Sa.set(-p,-o,p,o)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){q.setTransform(1,0,0,-1,p,o);!1===Sa.isEmpty()&&(Sa.minSelf(Wa),Sa.inflate(2),1>s&&q.clearRect(Math.floor(Sa.getX()),Math.floor(Sa.getY()),Math.floor(Sa.getWidth()),
Math.floor(Sa.getHeight())),0<s&&(c(THREE.NormalBlending),b(1),e("rgba("+Math.floor(255*t.r)+","+Math.floor(255*t.g)+","+Math.floor(255*t.b)+","+s+")"),q.fillRect(Math.floor(Sa.getX()),Math.floor(Sa.getY()),Math.floor(Sa.getWidth()),Math.floor(Sa.getHeight()))),Sa.empty())};this.render=function(a,l){function n(a,b,c){for(var d=0,e=i.length;d<e;d++){var f=i[d],g=f.color;if(f instanceof THREE.DirectionalLight){var h=f.matrixWorld.getPosition().normalize(),k=b.dot(h);0>=k||(k*=f.intensity,c.r+=g.r*k,
...
THREE.MeshLambertMaterial||j instanceof THREE.MeshPhongMaterial)&&null===j.map&&null===j.map?(aa.copy(j.color),ia.copy(j.emissive),j.vertexColors===THREE.FaceColors&&(aa.r*=i.color.r,aa.g*=i.color.g,aa.b*=i.color.b),!0===jb)?!1===j.wireframe&&j.shading==THREE.SmoothShading&&3==i.vertexNormalsLength?(fa.r=ca.r=Y.r=Oa.r,fa.g=ca.g=Y.g=Oa.g,fa.b=ca.b=Y.b=Oa.b,n(i.v1.positionWorld,i.vertexNormalsWorld[0],fa),n(i.v2.positionWorld,i.vertexNormalsWorld[1],ca),n(i.v3.positionWorld,i.vertexNormalsWorld[2],
...
(X.r=ic(i.normalWorld.x),X.g=ic(i.normalWorld.y),X.b=ic(i.normalWorld.z),!0===j.wireframe?t(X,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):w(X))}function r(a,b,c,d,e,f){q.beginPath();q.moveTo(a,b);q.lineTo(c,d);q.lineTo(e,f);q.closePath()}function s(a,b,c,d,e,f,g,h){q.beginPath();q.moveTo(a,b);q.lineTo(c,d);q.lineTo(e,f);q.lineTo(g,h);q.closePath()}function t(a,b,c,e){A!==b&&(A=q.lineWidth=b);v!==c&&(v=q.lineCap=c);u!==e&&(u=q.lineJoin=e);d(a.getContextStyle());q.stroke();Ka.inflate(2*
b)}function w(a){e(a.getContextStyle());q.fill()}function z(a,b,c,d,f,g,h,i,k,j,l,n,na){if(!(na instanceof THREE.DataTexture||void 0===na.image||0==na.image.width)){if(!0===na.needsUpdate){var m=na.wrapS==THREE.RepeatWrapping,o=na.wrapT==THREE.RepeatWrapping;Aa[na.id]=q.createPattern(na.image,!0===m&&!0===o?"repeat":!0===m&&!1===o?"repeat-x":!1===m&&!0===o?"repeat-y":"no-repeat");na.needsUpdate=!1}void 0===Aa[na.id]?e("rgba(0,0,0,1)"):e(Aa[na.id]);var m=na.offset.x/na.repeat.x,o=na.offset.y/na.repeat.y,
Db=na.image.width*na.repeat.x,p=na.image.height*na.repeat.y,h=(h+m)*Db,i=(1-i+o)*p,c=c-a,d=d-b,f=f-a,g=g-b,k=(k+m)*Db-h,j=(1-j+o)*p-i,l=(l+m)*Db-h,n=(1-n+o)*p-i,m=k*n-l*j;0===m?(void 0===Na[na.id]&&(b=document.createElement("canvas"),b.width=na.image.width,b.height=na.image.height,b=b.getContext("2d"),b.drawImage(na.image,0,0),Na[na.id]=b.getImageData(0,0,na.image.width,na.image.height).data),b=Na[na.id],h=4*(Math.floor(h)+Math.floor(i)*na.image.width),X.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),w(X)):
(m=1/m,na=(n*c-j*f)*m,j=(n*d-j*g)*m,c=(k*f-l*c)*m,d=(k*g-l*d)*m,a=a-na*h-c*i,h=b-j*h-d*i,q.save(),q.transform(na,j,c,d,a,h),q.fill(),q.restore())}}function na(a,b,c,d,e,f,g,h,i,k,j,l,na){var n,m;n=na.width-1;m=na.height-1;g*=n;h*=m;c-=a;d-=b;e-=a;f-=b;i=i*n-g;k=k*m-h;j=j*n-g;l=l*m-h;m=1/(i*l-j*k);n=(l*c-k*e)*m;k=(l*d-k*f)*m;c=(i*e-j*c)*m;d=(i*f-j*d)*m;a=a-n*g-c*h;b=b-k*g-d*h;q.save();q.transform(n,k,c,d,a,b);q.clip();q.drawImage(na,0,0);q.restore()}function yc(a,b,c,d){xa[0]=255*a.r|0;xa[1]=255*a.g|
0;xa[2]=255*a.b|0;xa[4]=255*b.r|0;xa[5]=255*b.g|0;xa[6]=255*b.b|0;xa[8]=255*c.r|0;xa[9]=255*c.g|0;xa[10]=255*c.b|0;xa[12]=255*d.r|0;xa[13]=255*d.g|0;xa[14]=255*d.b|0;ob.putImageData(bb,0,0);rb.drawImage(db,0,0);return lb}function Db(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function ic(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}function Zb(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===l instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
else{var $b,zc,ka,da;!0===this.autoClear?this.clear():q.setTransform(1,0,0,-1,p,o);f.info.render.vertices=0;f.info.render.faces=0;g=j.projectScene(a,l,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;jb=0<i.length;if(!0===jb){Oa.setRGB(0,0,0);kb.setRGB(0,0,0);ab.setRGB(0,0,0);$b=0;for(zc=i.length;$b<zc;$b++){da=i[$b];var la=da.color;da instanceof THREE.AmbientLight?(Oa.r+=la.r,Oa.g+=la.g,Oa.b+=la.b):da instanceof THREE.DirectionalLight?(kb.r+=la.r,kb.g+=la.g,kb.b+=la.b):da instanceof THREE.PointLight&&
(ab.r+=la.r,ab.g+=la.g,ab.b+=la.b)}}$b=0;for(zc=h.length;$b<zc;$b++)if(ka=h[$b],da=ka.material,!(void 0===da||!1===da.visible)){Ka.empty();if(ka instanceof THREE.RenderableParticle){D=ka;D.x*=p;D.y*=o;var la=D,E=ka;b(da.opacity);c(da.blending);var zb=void 0,Ab=void 0,sb=void 0,tb=void 0,jc=ka=void 0,Rc=void 0;da instanceof THREE.ParticleBasicMaterial?null===da.map?(sb=E.object.scale.x,tb=E.object.scale.y,sb*=E.scale.x*p,tb*=E.scale.y*o,Ka.set(la.x-sb,la.y-tb,la.x+sb,la.y+tb),!1!==Wa.intersects(Ka)&&
(e(da.color.getContextStyle()),q.save(),q.translate(la.x,la.y),q.rotate(-E.rotation),q.scale(sb,tb),q.fillRect(-1,-1,2,2),q.restore())):(ka=da.map.image,jc=ka.width>>1,Rc=ka.height>>1,sb=E.scale.x*p,tb=E.scale.y*o,zb=sb*jc,Ab=tb*Rc,Ka.set(la.x-zb,la.y-Ab,la.x+zb,la.y+Ab),!1!==Wa.intersects(Ka)&&(q.save(),q.translate(la.x,la.y),q.rotate(-E.rotation),q.scale(sb,-tb),q.translate(-jc,-Rc),q.drawImage(ka,0,0),q.restore())):da instanceof THREE.ParticleCanvasMaterial&&(zb=E.scale.x*p,Ab=E.scale.y*o,Ka.set(la.x-
zb,la.y-Ab,la.x+zb,la.y+Ab),!1!==Wa.intersects(Ka)&&(d(da.color.getContextStyle()),e(da.color.getContextStyle()),q.save(),q.translate(la.x,la.y),q.rotate(-E.rotation),q.scale(zb,Ab),da.program(q),q.restore()))}else if(ka instanceof THREE.RenderableLine){if(D=ka.v1,C=ka.v2,D.positionScreen.x*=p,D.positionScreen.y*=o,C.positionScreen.x*=p,C.positionScreen.y*=o,Ka.addPoint(D.positionScreen.x,D.positionScreen.y),Ka.addPoint(C.positionScreen.x,C.positionScreen.y),!0===Wa.intersects(Ka)&&(la=D,E=C,b(da.opacity),
c(da.blending),q.beginPath(),q.moveTo(la.positionScreen.x,la.positionScreen.y),q.lineTo(E.positionScreen.x,E.positionScreen.y),da instanceof THREE.LineBasicMaterial))la=da.linewidth,A!==la&&(A=q.lineWidth=la),la=da.linecap,v!==la&&(v=q.lineCap=la),la=da.linejoin,u!==la&&(u=q.lineJoin=la),d(da.color.getContextStyle()),q.stroke(),Ka.inflate(2*da.linewidth)}else if(ka instanceof THREE.RenderableFace3)D=ka.v1,C=ka.v2,G=ka.v3,D.positionScreen.x*=p,D.positionScreen.y*=o,C.positionScreen.x*=p,C.positionScreen.y*=
...
G.positionScreen.y),Ka.addPoint(P.positionScreen.x,P.positionScreen.y),!0===Wa.intersects(Ka)))(la=D,E=C,zb=G,Ab=P,sb=B,tb=K,jc=a,f.info.render.vertices+=4,f.info.render.faces++,b(da.opacity),c(da.blending),void 0!==da.map&&null!==da.map||void 0!==da.envMap&&null!==da.envMap)?(m(la,E,Ab,0,1,3,ka,da,jc),m(sb,zb,tb,1,2,3,ka,da,jc)):(H=la.positionScreen.x,I=la.positionScreen.y,N=E.positionScreen.x,O=E.positionScreen.y,R=zb.positionScreen.x,ga=zb.positionScreen.y,M=Ab.positionScreen.x,J=Ab.positionScreen.y,
Q=sb.positionScreen.x,Z=sb.positionScreen.y,L=tb.positionScreen.x,oa=tb.positionScreen.y,da instanceof THREE.MeshLambertMaterial||da instanceof THREE.MeshPhongMaterial)?(aa.copy(da.color),ia.copy(da.emissive),da.vertexColors===THREE.FaceColors&&(aa.r*=ka.color.r,aa.g*=ka.color.g,aa.b*=ka.color.b),!0===jb)?!1===da.wireframe&&da.shading==THREE.SmoothShading&&4==ka.vertexNormalsLength?(fa.r=ca.r=Y.r=ba.r=Oa.r,fa.g=ca.g=Y.g=ba.g=Oa.g,fa.b=ca.b=Y.b=ba.b=Oa.b,n(ka.v1.positionWorld,ka.vertexNormalsWorld[0],
...
(X.r=Oa.r,X.g=Oa.g,X.b=Oa.b,n(ka.centroidWorld,ka.normalWorld,X),X.r=X.r*aa.r+ia.r,X.g=X.g*aa.g+ia.g,X.b=X.b*aa.b+ia.b,s(H,I,N,O,R,ga,M,J),!0===da.wireframe?t(X,da.wireframeLinewidth,da.wireframeLinecap,da.wireframeLinejoin):w(X)):(X.r=aa.r+ia.r,X.g=aa.g+ia.g,X.b=aa.b+ia.b,s(H,I,N,O,R,ga,M,J),!0===da.wireframe?t(X,da.wireframeLinewidth,da.wireframeLinecap,da.wireframeLinejoin):w(X)):da instanceof THREE.MeshBasicMaterial?(X.copy(da.color),da.vertexColors===THREE.FaceColors&&(X.r*=ka.color.r,X.g*=ka.color.g,
X.b*=ka.color.b),s(H,I,N,O,R,ga,M,J),!0===da.wireframe?t(X,da.wireframeLinewidth,da.wireframeLinecap,da.wireframeLinejoin):w(X)):da instanceof THREE.MeshNormalMaterial?(X.r=ic(ka.normalWorld.x),X.g=ic(ka.normalWorld.y),X.b=ic(ka.normalWorld.z),s(H,I,N,O,R,ga,M,J),!0===da.wireframe?t(X,da.wireframeLinewidth,da.wireframeLinecap,da.wireframeLinejoin):w(X)):da instanceof THREE.MeshDepthMaterial&&(Ja=l.near,ma=l.far,fa.r=fa.g=fa.b=1-Db(la.positionScreen.z,Ja,ma),ca.r=ca.g=ca.b=1-Db(E.positionScreen.z,
Ja,ma),Y.r=Y.g=Y.b=1-Db(Ab.positionScreen.z,Ja,ma),ba.r=ba.g=ba.b=1-Db(zb.positionScreen.z,Ja,ma),sa=yc(fa,ca,Y,ba),r(H,I,N,O,M,J),na(H,I,N,O,M,J,0,0,1,0,0,1,sa),r(Q,Z,R,ga,L,oa),na(Q,Z,R,ga,L,oa,1,0,1,1,0,1,sa));Sa.addRectangle(Ka)}q.setTransform(1,0,0,1,0,0)}}};
...
o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,r=a.__webglCustomAttributesList;if(c.sortParticles){ob.copy(db);ob.multiplySelf(c.matrixWorld);for(d=0;d<g;d++)e=h[d],bb.copy(e),ob.multiplyVector3(bb),m[d]=[bb.z,d];m.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++)e=h[m[d][1]],f=3*d,l[f]=e.x,l[f+1]=e.y,l[f+2]=e.z;for(d=0;d<j;d++)f=3*d,e=i[m[d][1]],n[f]=e.r,n[f+1]=e.g,n[f+2]=e.b;if(r){i=0;for(j=r.length;i<j;i++)if(h=r[i],void 0===h.boundTo||"vertices"===h.boundTo)if(f=0,e=h.value.length,1===h.size)for(d=
...
c.color,c instanceof THREE.Fog?(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(lb){for(var l=0,n=0,m=0,o,p,r,q=rb,s=q.directional.colors,t=q.directional.positions,w=q.point.colors,z=q.point.positions,A=q.point.distances,B=q.spot.colors,C=q.spot.positions,D=q.spot.distances,G=q.spot.directions,X=q.spot.anglesCos,J=q.spot.exponents,K=q.hemi.skyColors,
Q=q.hemi.groundColors,M=q.hemi.positions,O=0,ca=0,N=0,R=0,ia=0,Z=0,ba=0,ga=0,qa=p=0,c=qa=qa=0,f=b.length;c<f;c++)j=b[c],j.onlyShadow||(o=j.color,r=j.intensity,p=j.distance,j instanceof THREE.AmbientLight?j.visible&&(L.gammaInput?(l+=o.r*o.r,n+=o.g*o.g,m+=o.b*o.b):(l+=o.r,n+=o.g,m+=o.b)):j instanceof THREE.DirectionalLight?(ia+=1,j.visible&&(p=3*O,L.gammaInput?v(s,p,o,r*r):u(s,p,o,r),xa.copy(j.matrixWorld.getPosition()),xa.subSelf(j.target.matrixWorld.getPosition()),xa.normalize(),t[p]=xa.x,t[p+1]=
xa.y,t[p+2]=xa.z,O+=1)):j instanceof THREE.PointLight?(Z+=1,j.visible&&(qa=3*ca,L.gammaInput?v(w,qa,o,r*r):u(w,qa,o,r),r=j.matrixWorld.getPosition(),z[qa]=r.x,z[qa+1]=r.y,z[qa+2]=r.z,A[ca]=p,ca+=1)):j instanceof THREE.SpotLight?(ba+=1,j.visible&&(qa=3*N,L.gammaInput?v(B,qa,o,r*r):u(B,qa,o,r),r=j.matrixWorld.getPosition(),C[qa]=r.x,C[qa+1]=r.y,C[qa+2]=r.z,D[N]=p,xa.copy(r),xa.subSelf(j.target.matrixWorld.getPosition()),xa.normalize(),G[qa]=xa.x,G[qa+1]=xa.y,G[qa+2]=xa.z,X[N]=Math.cos(j.angle),J[N]=
j.exponent,N+=1)):j instanceof THREE.HemisphereLight&&(ga+=1,j.visible&&(o=j.color,p=j.groundColor,qa=3*R,L.gammaInput?(r*=r,v(K,qa,o,r),v(Q,qa,p,r)):(u(K,qa,o,r),u(Q,qa,p,r)),xa.copy(j.matrixWorld.getPosition()),xa.normalize(),M[qa]=xa.x,M[qa+1]=xa.y,M[qa+2]=xa.z,R+=1)));c=3*O;for(f=Math.max(s.length,3*ia);c<f;c++)s[c]=0;c=3*O;for(f=Math.max(t.length,3*ia);c<f;c++)t[c]=0;c=3*ca;for(f=Math.max(w.length,3*Z);c<f;c++)w[c]=0;c=3*ca;for(f=Math.max(z.length,3*Z);c<f;c++)z[c]=0;c=ca;for(f=Math.max(A.length,
Z);c<f;c++)A[c]=0;c=3*N;for(f=Math.max(B.length,3*ba);c<f;c++)B[c]=0;c=3*N;for(f=Math.max(C.length,3*ba);c<f;c++)C[c]=0;c=3*N;for(f=Math.max(G.length,3*ba);c<f;c++)G[c]=0;c=N;for(f=Math.max(X.length,ba);c<f;c++)X[c]=0;c=N;for(f=Math.max(J.length,ba);c<f;c++)J[c]=0;c=N;for(f=Math.max(D.length,ba);c<f;c++)D[c]=0;c=3*R;for(f=Math.max(K.length,3*ga);c<f;c++)K[c]=0;c=3*R;for(f=Math.max(Q.length,3*ga);c<f;c++)Q[c]=0;c=3*R;for(f=Math.max(M.length,3*ga);c<f;c++)M[c]=0;q.directional.length=O;q.point.length=
ca;q.spot.length=N;q.hemi.length=R;q.ambient[0]=l;q.ambient[1]=n;q.ambient[2]=m;lb=!1}c=rb;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;i.spotLightDistance.value=c.spot.distances;i.spotLightDirection.value=
...
l);k.uniformMatrix4fv(f,!1,c._array)}else if("t"===l){if(m=j,j=E(),k.uniform1i(f,j),m)if(m.image instanceof Array&&6===m.image.length){if(c=m,f=j,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=k.createTexture());k.activeTexture(k.TEXTURE0+f);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;j=[];for(l=0;6>l;l++)L.autoScaleCubemaps&&!f?(n=j,m=l,q=c.image[l],t=
Qc,q.width<=t&&q.height<=t||(w=Math.max(q.width,q.height),s=Math.floor(q.width*t/w),t=Math.floor(q.height*t/w),w=document.createElement("canvas"),w.width=s,w.height=t,w.getContext("2d").drawImage(q,0,0,q.width,q.height,0,0,s,t),q=w),n[m]=q):j[l]=c.image[l];l=j[0];n=0===(l.width&l.width-1)&&0===(l.height&l.height-1);m=H(c.format);q=H(c.type);P(k.TEXTURE_CUBE_MAP,c,n);for(l=0;6>l;l++)if(f){t=j[l].mipmaps;w=0;for(z=t.length;w<z;w++)s=t[w],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,w,m,s.width,
s.height,0,s.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,m,m,q,j[l]);c.generateMipmaps&&n&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else k.activeTexture(k.TEXTURE0+f),k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else m instanceof THREE.WebGLRenderTargetCube?(c=m,k.activeTexture(k.TEXTURE0+j),k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)):L.setTexture(m,j)}else if("tv"===l){void 0===c._array&&(c._array=[]);l=0;for(n=c.value.length;l<
...
d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*d;a[b+2]=c.b*c.b*d}function u(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function D(a,b,c){ib!==a&&(a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL),ib=a);if(a&&(Bb!==b||Cb!==c))k.polygonOffset(b,c),Bb=b,Cb=c}function C(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function G(a,b){var c;"fragment"===a?c=k.createShader(k.FRAGMENT_SHADER):"vertex"===a&&(c=k.createShader(k.VERTEX_SHADER));k.shaderSource(c,
...
{memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var L=this,oa=[],X=0,fa=null,ca=null,Y=-1,ba=null,aa=null,ia=0,Aa=0,Na=-1,Ja=-1,ma=-1,sa=-1,Ea=-1,qb=-1,hb=-1,nb=-1,ib=null,Bb=null,Cb=null,Wa=null,Sa=0,Ka=0,jb=0,Oa=0,kb=0,ab=0,va=new THREE.Frustum,db=new THREE.Matrix4,ob=new THREE.Matrix4,bb=new THREE.Vector4,xa=new THREE.Vector3,lb=!0,rb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,
colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,yb,pb;try{if(!(k=I.getContext("experimental-webgl",{alpha:O,premultipliedAlpha:R,antialias:ga,stencil:M,preserveDrawingBuffer:J})))throw"Error creating WebGL context.";}catch(Pc){console.error(Pc)}a=k.getExtension("OES_texture_float");O=k.getExtension("OES_standard_derivatives");yb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||
k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");pb=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");a||console.log("THREE.WebGLRenderer: Float textures not supported.");O||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");yb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");pb||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");
k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(Q.r,Q.g,Q.b,Z);this.context=k;var xc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),O=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Qc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),oc=yb?k.getParameter(yb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):
0,gc=0<O,hc=gc&&a;pb&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);this.getContext=function(){return k};this.supportsVertexTextures=function(){return gc};this.getMaxAnisotropy=function(){return oc};this.setSize=function(a,b){I.width=a;I.height=b;this.setViewport(0,0,I.width,I.height)};this.setViewport=function(a,b,c,d){Sa=void 0!==a?a:0;Ka=void 0!==b?b:0;jb=void 0!==c?c:I.width;Oa=void 0!==d?d:I.height;k.viewport(Sa,Ka,jb,Oa)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=
...
else{var e,f,g,h,i=a.__lights,j=a.fog;Y=-1;lb=!0;this.autoUpdateScene&&a.updateMatrixWorld();void 0===b.parent&&b.updateMatrixWorld();b._viewMatrixArray||(b._viewMatrixArray=new Float32Array(16));b._projectionMatrixArray||(b._projectionMatrixArray=new Float32Array(16));b.matrixWorldInverse.getInverse(b.matrixWorld);b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);b.projectionMatrix.flattenToArray(b._projectionMatrixArray);db.multiply(b.projectionMatrix,b.matrixWorldInverse);va.setFromMatrix(db);
this.autoUpdateObjects&&this.initWebGLObjects(a);n(this.renderPluginsPre,a,b);L.info.render.calls=0;L.info.render.vertices=0;L.info.render.faces=0;L.info.render.points=0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);h=a.__webglObjects;d=0;for(e=h.length;d<e;d++)if(f=h[d],g=f.object,f.render=!1,g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||va.contains(g))){A(g,b);var m=f,r=m.buffer,
q=void 0,s=q=void 0,s=m.object.material;if(s instanceof THREE.MeshFaceMaterial)q=r.materialIndex,0<=q&&(q=s.materials[q],q.transparent?(m.transparent=q,m.opaque=null):(m.opaque=q,m.transparent=null));else if(q=s)q.transparent?(m.transparent=q,m.opaque=null):(m.opaque=q,m.transparent=null);f.render=!0;!0===this.sortObjects&&(null!==g.renderDepth?f.z=g.renderDepth:(bb.copy(g.matrixWorld.getPosition()),db.multiplyVector3(bb),f.z=bb.z),f.id=g.id)}this.sortObjects&&h.sort(l);h=a.__webglObjectsImmediate;
...
a.__objectsAdded[0],l=a,n=void 0,m=void 0,o=void 0,r=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,b instanceof THREE.Mesh)if(m=b.geometry,o=b.material,m instanceof THREE.Geometry){if(void 0===m.geometryGroups){var p=m,u=void 0,v=void 0,A=void 0,B=void 0,E=void 0,C=void 0,D=void 0,G={},H=p.morphTargets.length,I=p.morphNormals.length,X=o instanceof THREE.MeshFaceMaterial;p.geometryGroups={};u=0;for(v=p.faces.length;u<v;u++)A=p.faces[u],
B=X?A.materialIndex:void 0,C=void 0!==B?B:-1,void 0===G[C]&&(G[C]={hash:C,counter:0}),D=G[C].hash+"_"+G[C].counter,void 0===p.geometryGroups[D]&&(p.geometryGroups[D]={faces3:[],faces4:[],materialIndex:B,vertices:0,numMorphTargets:H,numMorphNormals:I}),E=A instanceof THREE.Face3?3:4,65535<p.geometryGroups[D].vertices+E&&(G[C].counter+=1,D=G[C].hash+"_"+G[C].counter,void 0===p.geometryGroups[D]&&(p.geometryGroups[D]={faces3:[],faces4:[],materialIndex:B,vertices:0,numMorphTargets:H,numMorphNormals:I})),
A instanceof THREE.Face3?p.geometryGroups[D].faces3.push(u):p.geometryGroups[D].faces4.push(u),p.geometryGroups[D].vertices+=E;p.geometryGroupsList=[];var Y=void 0;for(Y in p.geometryGroups)p.geometryGroups[Y].id=ia++,p.geometryGroupsList.push(p.geometryGroups[Y])}for(n in m.geometryGroups)if(r=m.geometryGroups[n],!r.__webglVertexBuffer){var J=r;J.__webglVertexBuffer=k.createBuffer();J.__webglNormalBuffer=k.createBuffer();J.__webglTangentBuffer=k.createBuffer();J.__webglColorBuffer=k.createBuffer();
...
Aa);ba.__sortArray=[];ba.__webglParticleCount=Aa;c(ba,ga);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0}else m instanceof THREE.BufferGeometry&&h(m);if(!b.__webglActive){if(b instanceof THREE.Mesh)if(m=b.geometry,m instanceof THREE.BufferGeometry)q(l.__webglObjects,m,b);else for(n in m.geometryGroups)r=m.geometryGroups[n],q(l.__webglObjects,r,b);else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(m=b.geometry,q(l.__webglObjects,m,b)):b instanceof THREE.ImmediateRenderObject||
...
Ja,Sa=qa,Ea=k.DYNAMIC_DRAW,hb=!T.dynamic,Wa=ma;if(ra.__inittedArrays){var lb=f(Wa),qb=Wa.vertexColors?Wa.vertexColors:!1,nb=g(Wa),kb=lb===THREE.SmoothShading,F=void 0,$=void 0,ab=void 0,S=void 0,db=void 0,bb=void 0,Eb=void 0,ob=void 0,Vb=void 0,ib=void 0,jb=void 0,U=void 0,V=void 0,W=void 0,pa=void 0,Fb=void 0,Gb=void 0,Hb=void 0,pb=void 0,Ib=void 0,Jb=void 0,Kb=void 0,rb=void 0,Lb=void 0,Mb=void 0,Nb=void 0,yb=void 0,Ob=void 0,Pb=void 0,Qb=void 0,Bb=void 0,Rb=void 0,Sb=void 0,Tb=void 0,Cb=void 0,
wa=void 0,gc=void 0,ac=void 0,kc=void 0,lc=void 0,Ta=void 0,hc=void 0,Qa=void 0,Ra=void 0,bc=void 0,Wb=void 0,La=0,Pa=0,Xb=0,Yb=0,ub=0,Za=0,Ba=0,cb=0,Ma=0,ha=0,ja=0,y=0,ya=void 0,Ua=ra.__vertexArray,pc=ra.__uvArray,qc=ra.__uv2Array,vb=ra.__normalArray,Fa=ra.__tangentArray,Va=ra.__colorArray,Ga=ra.__skinIndexArray,Ha=ra.__skinWeightArray,Sc=ra.__morphTargetsArrays,Tc=ra.__morphNormalsArrays,Uc=ra.__webglCustomAttributesList,x=void 0,Ub=ra.__faceArray,mb=ra.__lineArray,eb=Sa.geometry,xc=eb.elementsNeedUpdate,
oc=eb.uvsNeedUpdate,Pc=eb.normalsNeedUpdate,Qc=eb.tangentsNeedUpdate,hd=eb.colorsNeedUpdate,id=eb.morphTargetsNeedUpdate,ec=eb.vertices,ta=ra.faces3,ua=ra.faces4,$a=eb.faces,Vc=eb.faceVertexUvs[0],Wc=eb.faceVertexUvs[1],fc=eb.skinIndices,cc=eb.skinWeights,dc=eb.morphTargets,Ac=eb.morphNormals;if(eb.verticesNeedUpdate){F=0;for($=ta.length;F<$;F++)S=$a[ta[F]],U=ec[S.a],V=ec[S.b],W=ec[S.c],Ua[Pa]=U.x,Ua[Pa+1]=U.y,Ua[Pa+2]=U.z,Ua[Pa+3]=V.x,Ua[Pa+4]=V.y,Ua[Pa+5]=V.z,Ua[Pa+6]=W.x,Ua[Pa+7]=W.y,Ua[Pa+8]=
...
Cb=fc[S.d],Ga[ha]=Rb.x,Ga[ha+1]=Rb.y,Ga[ha+2]=Rb.z,Ga[ha+3]=Rb.w,Ga[ha+4]=Sb.x,Ga[ha+5]=Sb.y,Ga[ha+6]=Sb.z,Ga[ha+7]=Sb.w,Ga[ha+8]=Tb.x,Ga[ha+9]=Tb.y,Ga[ha+10]=Tb.z,Ga[ha+11]=Tb.w,Ga[ha+12]=Cb.x,Ga[ha+13]=Cb.y,Ga[ha+14]=Cb.z,Ga[ha+15]=Cb.w,ha+=16;0<ha&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ga,Ea),k.bindBuffer(k.ARRAY_BUFFER,ra.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Ha,Ea))}if(hd&&qb){F=0;for($=ta.length;F<$;F++)S=$a[ta[F]],Eb=S.vertexColors,
ob=S.color,3===Eb.length&&qb===THREE.VertexColors?(Lb=Eb[0],Mb=Eb[1],Nb=Eb[2]):Nb=Mb=Lb=ob,Va[Ma]=Lb.r,Va[Ma+1]=Lb.g,Va[Ma+2]=Lb.b,Va[Ma+3]=Mb.r,Va[Ma+4]=Mb.g,Va[Ma+5]=Mb.b,Va[Ma+6]=Nb.r,Va[Ma+7]=Nb.g,Va[Ma+8]=Nb.b,Ma+=9;F=0;for($=ua.length;F<$;F++)S=$a[ua[F]],Eb=S.vertexColors,ob=S.color,4===Eb.length&&qb===THREE.VertexColors?(Lb=Eb[0],Mb=Eb[1],Nb=Eb[2],yb=Eb[3]):yb=Nb=Mb=Lb=ob,Va[Ma]=Lb.r,Va[Ma+1]=Lb.g,Va[Ma+2]=Lb.b,Va[Ma+3]=Mb.r,Va[Ma+4]=Mb.g,Va[Ma+5]=Mb.b,Va[Ma+6]=Nb.r,Va[Ma+7]=Nb.g,Va[Ma+8]=
Nb.b,Va[Ma+9]=yb.r,Va[Ma+10]=yb.g,Va[Ma+11]=yb.b,Ma+=12;0<Ma&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,Va,Ea))}if(Qc&&eb.hasTangents){F=0;for($=ta.length;F<$;F++)S=$a[ta[F]],Vb=S.vertexTangents,Fb=Vb[0],Gb=Vb[1],Hb=Vb[2],Fa[Ba]=Fb.x,Fa[Ba+1]=Fb.y,Fa[Ba+2]=Fb.z,Fa[Ba+3]=Fb.w,Fa[Ba+4]=Gb.x,Fa[Ba+5]=Gb.y,Fa[Ba+6]=Gb.z,Fa[Ba+7]=Gb.w,Fa[Ba+8]=Hb.x,Fa[Ba+9]=Hb.y,Fa[Ba+10]=Hb.z,Fa[Ba+11]=Hb.w,Ba+=12;F=0;for($=ua.length;F<$;F++)S=$a[ua[F]],Vb=S.vertexTangents,Fb=Vb[0],
Gb=Vb[1],Hb=Vb[2],pb=Vb[3],Fa[Ba]=Fb.x,Fa[Ba+1]=Fb.y,Fa[Ba+2]=Fb.z,Fa[Ba+3]=Fb.w,Fa[Ba+4]=Gb.x,Fa[Ba+5]=Gb.y,Fa[Ba+6]=Gb.z,Fa[Ba+7]=Gb.w,Fa[Ba+8]=Hb.x,Fa[Ba+9]=Hb.y,Fa[Ba+10]=Hb.z,Fa[Ba+11]=Hb.w,Fa[Ba+12]=pb.x,Fa[Ba+13]=pb.y,Fa[Ba+14]=pb.z,Fa[Ba+15]=pb.w,Ba+=16;k.bindBuffer(k.ARRAY_BUFFER,ra.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Fa,Ea)}if(Pc&&lb){F=0;for($=ta.length;F<$;F++)if(S=$a[ta[F]],db=S.vertexNormals,bb=S.normal,3===db.length&&kb)for(wa=0;3>wa;wa++)ac=db[wa],vb[Za]=ac.x,vb[Za+1]=
ac.y,vb[Za+2]=ac.z,Za+=3;else for(wa=0;3>wa;wa++)vb[Za]=bb.x,vb[Za+1]=bb.y,vb[Za+2]=bb.z,Za+=3;F=0;for($=ua.length;F<$;F++)if(S=$a[ua[F]],db=S.vertexNormals,bb=S.normal,4===db.length&&kb)for(wa=0;4>wa;wa++)ac=db[wa],vb[Za]=ac.x,vb[Za+1]=ac.y,vb[Za+2]=ac.z,Za+=3;else for(wa=0;4>wa;wa++)vb[Za]=bb.x,vb[Za+1]=bb.y,vb[Za+2]=bb.z,Za+=3;k.bindBuffer(k.ARRAY_BUFFER,ra.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,vb,Ea)}if(oc&&Vc&&nb){F=0;for($=ta.length;F<$;F++)if(ab=ta[F],ib=Vc[ab],void 0!==ib)for(wa=
0;3>wa;wa++)kc=ib[wa],pc[Xb]=kc.u,pc[Xb+1]=kc.v,Xb+=2;F=0;for($=ua.length;F<$;F++)if(ab=ua[F],ib=Vc[ab],void 0!==ib)for(wa=0;4>wa;wa++)kc=ib[wa],pc[Xb]=kc.u,pc[Xb+1]=kc.v,Xb+=2;0<Xb&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,pc,Ea))}if(oc&&Wc&&nb){F=0;for($=ta.length;F<$;F++)if(ab=ta[F],jb=Wc[ab],void 0!==jb)for(wa=0;3>wa;wa++)lc=jb[wa],qc[Yb]=lc.u,qc[Yb+1]=lc.v,Yb+=2;F=0;for($=ua.length;F<$;F++)if(ab=ua[F],jb=Wc[ab],void 0!==jb)for(wa=0;4>wa;wa++)lc=jb[wa],qc[Yb]=
lc.u,qc[Yb+1]=lc.v,Yb+=2;0<Yb&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,qc,Ea))}if(xc){F=0;for($=ta.length;F<$;F++)Ub[ub]=La,Ub[ub+1]=La+1,Ub[ub+2]=La+2,ub+=3,mb[cb]=La,mb[cb+1]=La+1,mb[cb+2]=La,mb[cb+3]=La+2,mb[cb+4]=La+1,mb[cb+5]=La+2,cb+=6,La+=3;F=0;for($=ua.length;F<$;F++)Ub[ub]=La,Ub[ub+1]=La+1,Ub[ub+2]=La+3,Ub[ub+3]=La+1,Ub[ub+4]=La+2,Ub[ub+5]=La+3,ub+=6,mb[cb]=La,mb[cb+1]=La+1,mb[cb+2]=La,mb[cb+3]=La+3,mb[cb+4]=La+1,mb[cb+5]=La+2,mb[cb+6]=La+2,mb[cb+7]=
La+3,cb+=8,La+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ra.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Ub,Ea);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ra.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,mb,Ea)}if(Uc){wa=0;for(gc=Uc.length;wa<gc;wa++)if(x=Uc[wa],x.__original.needsUpdate){y=0;if(1===x.size)if(void 0===x.boundTo||"vertices"===x.boundTo){F=0;for($=ta.length;F<$;F++)S=$a[ta[F]],x.array[y]=x.value[S.a],x.array[y+1]=x.value[S.b],x.array[y+2]=x.value[S.c],y+=3;F=0;for($=ua.length;F<
...
Ca.boundTo)){za=0;mc=Ca.value.length;if(1===Ca.size)for(Xa=0;Xa<mc;Xa++)Ca.array[Xa]=Ca.value[Xa];else if(2===Ca.size)for(Xa=0;Xa<mc;Xa++)fb=Ca.value[Xa],Ca.array[za]=fb.x,Ca.array[za+1]=fb.y,za+=2;else if(3===Ca.size)if("c"===Ca.type)for(Xa=0;Xa<mc;Xa++)fb=Ca.value[Xa],Ca.array[za]=fb.r,Ca.array[za+1]=fb.g,Ca.array[za+2]=fb.b,za+=3;else for(Xa=0;Xa<mc;Xa++)fb=Ca.value[Xa],Ca.array[za]=fb.x,Ca.array[za+1]=fb.y,Ca.array[za+2]=fb.z,za+=3;else if(4===Ca.size)for(Xa=0;Xa<mc;Xa++)fb=Ca.value[Xa],Ca.array[za]=
fb.x,Ca.array[za+1]=fb.y,Ca.array[za+2]=fb.z,Ca.array[za+3]=fb.w,za+=4;k.bindBuffer(k.ARRAY_BUFFER,Ca.buffer);k.bufferData(k.ARRAY_BUFFER,Ca.array,Bc)}}}T.verticesNeedUpdate=!1;T.colorsNeedUpdate=!1;T.normalsNeedUpdate=!1;ma.attributes&&s(ma)}else if(qa instanceof THREE.Line){ma=e(qa,T);va=ma.attributes&&t(ma);if(T.verticesNeedUpdate||T.colorsNeedUpdate||T.lineDistancesNeedUpdate||va){var xb=T,Jc=k.DYNAMIC_DRAW,uc=void 0,vc=void 0,wc=void 0,Kc=void 0,Ia=void 0,Lc=void 0,cd=xb.vertices,dd=xb.colors,
ed=xb.lineDistances,od=cd.length,pd=dd.length,qd=ed.length,Mc=xb.__vertexArray,Nc=xb.__colorArray,fd=xb.__lineDistanceArray,rd=xb.colorsNeedUpdate,sd=xb.lineDistancesNeedUpdate,Yc=xb.__webglCustomAttributesList,Oc=void 0,gd=void 0,Ya=void 0,nc=void 0,gb=void 0,Da=void 0;if(xb.verticesNeedUpdate){for(uc=0;uc<od;uc++)Kc=cd[uc],Ia=3*uc,Mc[Ia]=Kc.x,Mc[Ia+1]=Kc.y,Mc[Ia+2]=Kc.z;k.bindBuffer(k.ARRAY_BUFFER,xb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Mc,Jc)}if(rd){for(vc=0;vc<pd;vc++)Lc=dd[vc],Ia=
3*vc,Nc[Ia]=Lc.r,Nc[Ia+1]=Lc.g,Nc[Ia+2]=Lc.b;k.bindBuffer(k.ARRAY_BUFFER,xb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Nc,Jc)}if(sd){for(wc=0;wc<qd;wc++)fd[wc]=ed[wc];k.bindBuffer(k.ARRAY_BUFFER,xb.__webglLineDistanceBuffer);k.bufferData(k.ARRAY_BUFFER,fd,Jc)}if(Yc){Oc=0;for(gd=Yc.length;Oc<gd;Oc++)if(Da=Yc[Oc],Da.needsUpdate&&(void 0===Da.boundTo||"vertices"===Da.boundTo)){Ia=0;nc=Da.value.length;if(1===Da.size)for(Ya=0;Ya<nc;Ya++)Da.array[Ya]=Da.value[Ya];else if(2===Da.size)for(Ya=0;Ya<nc;Ya++)gb=
Da.value[Ya],Da.array[Ia]=gb.x,Da.array[Ia+1]=gb.y,Ia+=2;else if(3===Da.size)if("c"===Da.type)for(Ya=0;Ya<nc;Ya++)gb=Da.value[Ya],Da.array[Ia]=gb.r,Da.array[Ia+1]=gb.g,Da.array[Ia+2]=gb.b,Ia+=3;else for(Ya=0;Ya<nc;Ya++)gb=Da.value[Ya],Da.array[Ia]=gb.x,Da.array[Ia+1]=gb.y,Da.array[Ia+2]=gb.z,Ia+=3;else if(4===Da.size)for(Ya=0;Ya<nc;Ya++)gb=Da.value[Ya],Da.array[Ia]=gb.x,Da.array[Ia+1]=gb.y,Da.array[Ia+2]=gb.z,Da.array[Ia+3]=gb.w,Ia+=4;k.bindBuffer(k.ARRAY_BUFFER,Da.buffer);k.bufferData(k.ARRAY_BUFFER,
Da.array,Jc)}}}T.verticesNeedUpdate=!1;T.colorsNeedUpdate=!1;T.lineDistancesNeedUpdate=!1;ma.attributes&&s(ma)}else qa instanceof THREE.ParticleSystem&&(T instanceof THREE.BufferGeometry?((T.verticesNeedUpdate||T.colorsNeedUpdate)&&j(T,k.DYNAMIC_DRAW,!T.dynamic),T.verticesNeedUpdate=!1,T.colorsNeedUpdate=!1):(ma=e(qa,T),va=ma.attributes&&t(ma),(T.verticesNeedUpdate||T.colorsNeedUpdate||qa.sortParticles||va)&&i(T,k.DYNAMIC_DRAW,qa),T.verticesNeedUpdate=!1,T.colorsNeedUpdate=!1,ma.attributes&&s(ma)))}};
...
a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var p,r,q;e=p=r=q=o=0;for(f=b.length;e<f;e++)g=b[e],g.onlyShadow||(g instanceof THREE.DirectionalLight&&p++,g instanceof THREE.PointLight&&r++,g instanceof THREE.SpotLight&&q++,g instanceof THREE.HemisphereLight&&o++);e=p;f=r;g=q;h=o;o=p=0;for(q=b.length;o<q;o++)r=b[o],r.castShadow&&(r instanceof THREE.SpotLight&&p++,r instanceof THREE.DirectionalLight&&!r.shadowCascade&&p++);m=p;hc&&d&&d.useVertexTexture?l=1024:(b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS),
b=Math.floor((b-20)/4),void 0!==d&&d instanceof THREE.SkinnedMesh&&(b=Math.min(d.bones.length,b),b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+d.bones.length+", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")),l=b);var s;a:{r=a.fragmentShader;q=a.vertexShader;o=a.uniforms;b=a.attributes;p=a.defines;var c={map:!!a.map,envMap:!!a.envMap,lightMap:!!a.lightMap,bumpMap:!!a.bumpMap,normalMap:!!a.normalMap,specularMap:!!a.specularMap,vertexColors:a.vertexColors,fog:c,useFog:a.fog,
...
shadowMapDebug:this.shadowMapDebug,shadowMapCascade:this.shadowMapCascade,alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,u,v,d=[];n?d.push(n):(d.push(r),d.push(q));for(u in p)d.push(u),d.push(p[u]);for(t in c)d.push(t),d.push(c[t]);n=d.join();t=0;for(u=oa.length;t<u;t++)if(d=oa[t],d.code===n){d.usedTimes++;s=d.program;break a}t=[];for(v in p)u=p[v],!1!==u&&(u="#define "+v+" "+u,t.push(u));u=
...
w);for(w=0;w<c.maxMorphNormals;w++)t.push("morphNormal"+w);for(s in b)t.push(s);s=t;w=0;for(b=s.length;w<b;w++)t=s[w],v.attributes[t]=k.getAttribLocation(v,t);v.id=X++;oa.push({program:v,code:n,usedTimes:1});L.info.memory.programs=oa.length;s=v}a.program=s;s=a.program.attributes;0<=s.position&&k.enableVertexAttribArray(s.position);0<=s.color&&k.enableVertexAttribArray(s.color);0<=s.normal&&k.enableVertexAttribArray(s.normal);0<=s.tangent&&k.enableVertexAttribArray(s.tangent);0<=s.lineDistance&&k.enableVertexAttribArray(s.lineDistance);
...
k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer),k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0),B(a.__webglRenderbuffer,a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=jb,a=Oa,d=Sa,e=Ka);b!==ca&&(k.bindFramebuffer(k.FRAMEBUFFER,
b),k.viewport(d,e,c,a),ca=b);kb=c;ab=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
...
j[1],w=j[2],0===e?(l=r.clone(),l.lerpSelf(h,0.5),j=[r.clone(),l.clone(),w.clone()],h=[l.clone(),h.clone(),w.clone()]):1===e?(l=h.clone(),l.lerpSelf(w,0.5),j=[r.clone(),h.clone(),l.clone()],h=[l.clone(),w.clone(),r.clone()]):(l=r.clone(),l.lerpSelf(w,0.5),j=[r.clone(),h.clone(),l.clone()],h=[l.clone(),h.clone(),w.clone()]),A[f].push(j,h))}else{E.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)A[f].push(a.faceVertexUvs[f][c])}else if(f=e.a,g=e.b,h=e.c,i=e.d,j=a.vertices[f],l=a.vertices[g],m=a.vertices[h],
n=a.vertices[i],p=j.distanceTo(l),o=l.distanceTo(m),q=m.distanceTo(n),t=j.distanceTo(n),p>b||o>b||q>b||t>b){s=a.vertices.length;z=a.vertices.length+1;w=e.clone();r=e.clone();p>=o&&p>=q&&p>=t||q>=o&&q>=p&&q>=t?(p=j.clone(),p.lerpSelf(l,0.5),l=m.clone(),l.lerpSelf(n,0.5),w.a=f,w.b=s,w.c=z,w.d=i,r.a=s,r.b=g,r.c=h,r.d=z,4===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),g=e.vertexNormals[2].clone(),g.lerpSelf(e.vertexNormals[3],0.5),w.vertexNormals[1].copy(f),
w.vertexNormals[2].copy(g),r.vertexNormals[0].copy(f),r.vertexNormals[3].copy(g)),4===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[1],0.5),g=e.vertexColors[2].clone(),g.lerpSelf(e.vertexColors[3],0.5),w.vertexColors[1].copy(f),w.vertexColors[2].copy(g),r.vertexColors[0].copy(f),r.vertexColors[3].copy(g)),e=0):(p=l.clone(),p.lerpSelf(m,0.5),l=n.clone(),l.lerpSelf(j,0.5),w.a=f,w.b=g,w.c=s,w.d=z,r.a=z,r.b=s,r.c=h,r.d=i,4===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),
...
f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],r=j[0],h=j[1],w=j[2],j=j[3],0===e?(l=r.clone(),l.lerpSelf(h,0.5),m=w.clone(),m.lerpSelf(j,0.5),r=[r.clone(),l.clone(),m.clone(),j.clone()],h=[l.clone(),h.clone(),w.clone(),m.clone()]):(l=h.clone(),l.lerpSelf(w,0.5),m=j.clone(),m.lerpSelf(r,0.5),r=[r.clone(),h.clone(),l.clone(),m.clone()],h=[m.clone(),l.clone(),w.clone(),j.clone()]),A[f].push(r,h))}else{E.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)A[f].push(a.faceVertexUvs[f][c])}a.faces=
...
(function(a){var b=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};a.Triangulate=function(a,d){var e=a.length;if(3>e)return null;var f=[],g=[],h=[],i,j,l;if(0<b(a))for(j=0;j<e;j++)g[j]=j;else for(j=0;j<e;j++)g[j]=e-1-j;var m=2*e;for(j=e-1;2<e;){if(0>=m--){console.log("Warning, unable to triangulate polygon!");break}i=j;e<=i&&(i=0);j=i+1;e<=j&&(j=0);l=j+1;e<=l&&(l=0);var n;a:{n=a;var p=i,o=j,q=l,t=e,s=g,z=void 0,w=void 0,r=void 0,E=void 0,A=void 0,
v=void 0,u=void 0,D=void 0,C=void 0,w=n[s[p]].x,r=n[s[p]].y,E=n[s[o]].x,A=n[s[o]].y,v=n[s[q]].x,u=n[s[q]].y;if(1E-10>(E-w)*(u-r)-(A-r)*(v-w))n=!1;else{for(z=0;z<t;z++)if(!(z==p||z==o||z==q)){var D=n[s[z]].x,C=n[s[z]].y,G=void 0,P=void 0,B=void 0,K=void 0,H=void 0,I=void 0,N=void 0,O=void 0,R=void 0,ga=void 0,M=void 0,J=void 0,G=B=H=void 0,G=v-E,P=u-A,B=w-v,K=r-u,H=E-w,I=A-r,N=D-w,O=C-r,R=D-E,ga=C-A,M=D-v,J=C-u,G=G*ga-P*R,H=H*O-I*N,B=B*J-K*M;if(0<=G&&0<=B&&0<=H){n=!1;break a}}n=!0}}if(n){f.push([a[g[i]],
...
THREE.CubeGeometry=function(a,b,c,d,e,f){function g(a,b,c,d,e,f,g,q){var t,s=h.widthSegments,z=h.heightSegments,w=e/2,r=f/2,E=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)t="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)t="y",z=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)t="x",s=h.depthSegments;var A=s+1,v=z+1,u=e/s,D=f/z,C=new THREE.Vector3;C[t]=0<g?1:-1;for(e=0;e<v;e++)for(f=0;f<A;f++){var G=new THREE.Vector3;G[a]=(f*u-w)*c;G[b]=(e*D-r)*d;G[t]=g;h.vertices.push(G)}for(e=
0;e<z;e++)for(f=0;f<s;f++)a=new THREE.Face4(f+A*e+E,f+A*(e+1)+E,f+1+A*(e+1)+E,f+1+A*e+E),a.normal.copy(C),a.vertexNormals.push(C.clone(),C.clone(),C.clone(),C.clone()),a.materialIndex=q,h.faces.push(a),h.faceVertexUvs[0].push([new THREE.UV(f/s,1-e/z),new THREE.UV(f/s,1-(e+1)/z),new THREE.UV((f+1)/s,1-(e+1)/z),new THREE.UV((f+1)/s,1-e/z)])}THREE.Geometry.call(this);var h=this;this.width=a;this.height=b;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=f||1;a=this.width/
...
1]].clone()):(m=this.vertices[j[1][h]].clone(),n=this.vertices[j[1][h+1]].clone());m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();for(i=0;i<e;i++){var p=j[i][h],o=j[i+1][h],q=j[i+1][h+1],t=j[i][h+1],s=m.clone(),z=m.clone(),w=n.clone(),r=n.clone(),E=l[i][h].clone(),A=l[i+1][h].clone(),v=l[i+1][h+1].clone(),u=l[i][h+1].clone();this.faces.push(new THREE.Face4(p,o,q,t,[s,z,w,r]));this.faceVertexUvs[0].push([E,A,v,u])}}if(!f&&0<a){this.vertices.push(new THREE.Vector3(0,
g,0));for(h=0;h<d;h++)p=j[0][h],o=j[0][h+1],q=this.vertices.length-1,s=new THREE.Vector3(0,1,0),z=new THREE.Vector3(0,1,0),w=new THREE.Vector3(0,1,0),E=l[0][h].clone(),A=l[0][h+1].clone(),v=new THREE.UV(A.u,0),this.faces.push(new THREE.Face3(p,o,q,[s,z,w])),this.faceVertexUvs[0].push([E,A,v])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)p=j[i][h+1],o=j[i][h],q=this.vertices.length-1,s=new THREE.Vector3(0,-1,0),z=new THREE.Vector3(0,-1,0),w=new THREE.Vector3(0,-1,0),E=
l[i][h+1].clone(),A=l[i][h].clone(),v=new THREE.UV(A.u,1),this.faces.push(new THREE.Face3(p,o,q,[s,z,w])),this.faceVertexUvs[0].push([E,A,v])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};
...
[],L,oa=M.concat();u=0;for(D=p.length;u<D;u++){v=p[u];L=[];J=0;Q=v.length;H=Q-1;for(I=J+1;J<Q;J++,H++,I++)H===Q&&(H=0),I===Q&&(I=0),L[J]=d(v[J],v[H],v[I]);Z.push(L);oa=oa.concat(L)}for(H=0;H<l;H++){v=H/l;N=i*(1-v);I=j*Math.sin(v*Math.PI/2);J=0;for(Q=B.length;J<Q;J++)O=c(B[J],M[J],I),f(O.x,O.y,-N);u=0;for(D=p.length;u<D;u++){v=p[u];L=Z[u];J=0;for(Q=v.length;J<Q;J++)O=c(v[J],L[J],I),f(O.x,O.y,-N)}}I=j;for(J=0;J<R;J++)O=m?c(P[J],oa[J],I):P[J],q?(E.copy(w.normals[0]).multiplyScalar(O.x),r.copy(w.binormals[0]).multiplyScalar(O.y),
A.copy(o[0]).addSelf(E).addSelf(r),f(A.x,A.y,A.z)):f(O.x,O.y,0);for(v=1;v<=n;v++)for(J=0;J<R;J++)O=m?c(P[J],oa[J],I):P[J],q?(E.copy(w.normals[v]).multiplyScalar(O.x),r.copy(w.binormals[v]).multiplyScalar(O.y),A.copy(o[v]).addSelf(E).addSelf(r),f(A.x,A.y,A.z)):f(O.x,O.y,h/n*v);for(H=l-1;0<=H;H--){v=H/l;N=i*(1-v);I=j*Math.sin(v*Math.PI/2);J=0;for(Q=B.length;J<Q;J++)O=c(B[J],M[J],I),f(O.x,O.y,h+N);u=0;for(D=p.length;u<D;u++){v=p[u];L=Z[u];J=0;for(Q=v.length;J<Q;J++)O=c(v[J],L[J],I),q?f(O.x,O.y+o[n-1].y,
...
THREE.SubdivisionModifier.prototype.smooth=function(a){function b(){l.debug&&(console&&console.assert)&&console.assert.apply(console,arguments)}function c(){l.debug&&console.log.apply(console,arguments)}function d(){console&&console.log.apply(console,arguments)}function e(a,b,d,e,g,h,m){var n=new THREE.Face4(a,b,d,e,null,g.color,g.materialIndex);if(l.useOldVertexColors){n.vertexColors=[];for(var o,r,p,q=0;4>q;q++){p=h[q];o=new THREE.Color;o.setRGB(0,0,0);for(var s=0;s<p.length;s++)r=g.vertexColors[p[s]-
1],o.r+=r.r,o.g+=r.g,o.b+=r.b;o.r/=p.length;o.g/=p.length;o.b/=p.length;n.vertexColors[q]=o}}i.push(n);l.supportUVs&&(g=[f(a,""),f(b,m),f(d,m),f(e,m)],g[0]?g[1]?g[2]?g[3]?j.push(g):c("d :( ",e+":"+m):c("c :( ",d+":"+m):c("b :( ",b+":"+m):c("a :( ",a+":"+m))}function f(a,b){var e=a+":"+b,f=w[e];return!f?(a>=q&&a<q+o.length?c("face pt"):c("edge pt"),d("warning, UV not found for",e),null):f}function g(a,b,c){var e=a+":"+b;e in w?d("dup vertexNo",a,"oldFaceNo",b,"value",c,"key",e,w[e]):w[e]=c}var h=[],
i=[],j=[],l=this,m=THREE.GeometryUtils.orderedKey,n=THREE.GeometryUtils.computeEdgeFaces,p=a.vertices,o=a.faces,q=p.length,h=p.concat(),t=[],s={},z={},w={},r,E,A,v,u,D=a.faceVertexUvs[0],C;c("originalFaces, uvs, originalVerticesLength",o.length,D.length,q);if(l.supportUVs){r=0;for(E=D.length;r<E;r++){A=0;for(v=D[r].length;A<v;A++)C=o[r]["abcd".charAt(A)],g(C,r,D[r][A])}}0==D.length&&(l.supportUVs=!1);r=0;for(var G in w)r++;r||(l.supportUVs=!1,c("no uvs"));r=0;for(E=o.length;r<E;r++)u=o[r],t.push(u.centroid),
h.push(u.centroid),l.supportUVs&&(v=new THREE.UV,u instanceof THREE.Face3?(v.u=f(u.a,r).u+f(u.b,r).u+f(u.c,r).u,v.v=f(u.a,r).v+f(u.b,r).v+f(u.c,r).v,v.u/=3,v.v/=3):u instanceof THREE.Face4&&(v.u=f(u.a,r).u+f(u.b,r).u+f(u.c,r).u+f(u.d,r).u,v.v=f(u.a,r).v+f(u.b,r).v+f(u.c,r).v+f(u.d,r).v,v.u/=4,v.v/=4),g(q+r,"",v));var n=n(a),P;E=0;var B,K;G={};D={};for(r in n){C=n[r];B=r.split("_");K=B[0];B=B[1];A=K;u=[K,B];void 0===G[A]&&(G[A]=[]);G[A].push(u);A=B;u=[K,B];void 0===G[A]&&(G[A]=[]);G[A].push(u);A=0;
for(v=C.length;A<v;A++){u=C[A];P=K;var H=u,I=r;void 0===D[P]&&(D[P]={});D[P][H]=I;P=B;H=r;void 0===D[P]&&(D[P]={});D[P][u]=H}2>C.length&&(z[r]=!0)}for(r in n)if(C=n[r],u=C[0],P=C[1],B=r.split("_"),K=B[0],B=B[1],v=new THREE.Vector3,b(0<C.length,"an edge without faces?!"),1==C.length?(v.addSelf(p[K]),v.addSelf(p[B]),v.multiplyScalar(0.5)):(v.addSelf(t[u]),v.addSelf(t[P]),v.addSelf(p[K]),v.addSelf(p[B]),v.multiplyScalar(0.25)),s[r]=q+o.length+E,h.push(v),E++,l.supportUVs)v=new THREE.UV,v.u=f(K,u).u+
f(B,u).u,v.v=f(K,u).v+f(B,u).v,v.u/=2,v.v/=2,g(s[r],u,v),2<=C.length&&(b(2==C.length,"did we plan for more than 2 edges?"),v=new THREE.UV,v.u=f(K,P).u+f(B,P).u,v.v=f(K,P).v+f(B,P).v,v.u/=2,v.v/=2,g(s[r],P,v));c("-- Step 2 done");var N,O;v=["123","12","2","23"];P=["123","23","3","31"];var H=["123","31","1","12"],I=["1234","12","2","23"],R=["1234","23","3","34"],ga=["1234","34","4","41"],M=["1234","41","1","12"];r=0;for(E=t.length;r<E;r++)u=o[r],C=q+r,u instanceof THREE.Face3?(K=m(u.a,u.b),B=m(u.b,
u.c),N=m(u.c,u.a),e(C,s[K],u.b,s[B],u,v,r),e(C,s[B],u.c,s[N],u,P,r),e(C,s[N],u.a,s[K],u,H,r)):u instanceof THREE.Face4?(K=m(u.a,u.b),B=m(u.b,u.c),N=m(u.c,u.d),O=m(u.d,u.a),e(C,s[K],u.b,s[B],u,I,r),e(C,s[B],u.c,s[N],u,R,r),e(C,s[N],u.d,s[O],u,ga,r),e(C,s[O],u.a,s[K],u,M,r)):c("face should be a face!",u);s=new THREE.Vector3;u=new THREE.Vector3;r=0;for(E=p.length;r<E;r++)if(void 0!==G[r]){s.set(0,0,0);u.set(0,0,0);B=new THREE.Vector3(0,0,0);C=0;for(A in D[r])s.addSelf(t[A]),C++;P=0;K=G[r].length;v=C!=
K;for(A=0;A<K;A++)z[m(G[r][A][0],G[r][A][1])]&&P++;s.divideScalar(C);P=0;if(v){for(A=0;A<K;A++)if(C=G[r][A],H=1==n[m(C[0],C[1])].length)C=p[C[0]].clone().addSelf(p[C[1]]).divideScalar(2),u.addSelf(C),P++;u.divideScalar(4);b(2==P,"should have only 2 boundary edges")}else{for(A=0;A<K;A++)C=G[r][A],C=p[C[0]].clone().addSelf(p[C[1]]).divideScalar(2),u.addSelf(C);u.divideScalar(K)}B.addSelf(p[r]);v?(B.divideScalar(2),B.addSelf(u)):(B.multiplyScalar(K-3),B.addSelf(s),B.addSelf(u.multiplyScalar(2)),B.divideScalar(K));
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(l,m){var n,p,o,q,t,s,z,w,r,E=[];q=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFrontFaces?
...
A.shadowCameraBottom=r.shadowCameraBottom;A.shadowCameraTop=r.shadowCameraTop;A.shadowCameraVisible=r.shadowCameraVisible;A.shadowDarkness=r.shadowDarkness;A.shadowBias=r.shadowCascadeBias[z];A.shadowMapWidth=r.shadowCascadeWidth[z];A.shadowMapHeight=r.shadowCascadeHeight[z];A.pointsWorld=[];A.pointsFrustum=[];w=A.pointsWorld;s=A.pointsFrustum;for(var v=0;8>v;v++)w[v]=new THREE.Vector3,s[v]=new THREE.Vector3;w=r.shadowCascadeNearZ[z];r=r.shadowCascadeFarZ[z];s[0].set(-1,-1,w);s[1].set(1,-1,w);s[2].set(-1,
1,w);s[3].set(1,1,w);s[4].set(-1,-1,r);s[5].set(1,-1,r);s[6].set(-1,1,r);s[7].set(1,1,r);A.originalCamera=m;s=new THREE.Gyroscope;s.position=o.shadowCascadeOffset;s.add(A);s.add(A.target);m.add(s);o.shadowCascadeArray[t]=A;console.log("Created virtualLight",A)}z=o;w=t;r=z.shadowCascadeArray[w];r.position.copy(z.position);r.target.position.copy(z.target.position);r.lookAt(r.target);r.shadowCameraVisible=z.shadowCameraVisible;r.shadowDarkness=z.shadowDarkness;r.shadowBias=z.shadowCascadeBias[w];s=z.shadowCascadeNearZ[w];
z=z.shadowCascadeFarZ[w];r=r.pointsFrustum;r[0].z=s;r[1].z=s;r[2].z=s;r[3].z=s;r[4].z=z;r[5].z=z;r[6].z=z;r[7].z=z;E[q]=A;q++}else E[q]=o,q++;n=0;for(p=E.length;n<p;n++){o=E[n];o.shadowMap||(o.shadowMap=new THREE.WebGLRenderTarget(o.shadowMapWidth,o.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat}),o.shadowMapSize=new THREE.Vector2(o.shadowMapWidth,o.shadowMapHeight),o.shadowMatrix=new THREE.Matrix4);if(!o.shadowCamera){if(o instanceof THREE.SpotLight)o.shadowCamera=
...
new THREE.CameraHelper(o.shadowCamera),o.shadowCamera.add(o.cameraHelper));if(o.isVirtual&&A.originalCamera==m){t=m;q=o.shadowCamera;s=o.pointsFrustum;r=o.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(z=0;8>z;z++)if(w=r[z],w.copy(s[z]),THREE.ShadowMapPlugin.__projector.unprojectVector(w,t),q.matrixWorldInverse.multiplyVector3(w),w.x<i.x&&(i.x=w.x),w.x>j.x&&(j.x=w.x),w.y<i.y&&(i.y=w.y),w.y>j.y&&(j.y=w.y),w.z<i.z&&(i.z=w.z),w.z>j.z)j.z=w.z;q.left=i.x;q.right=
...
!s.frustumCulled||g.contains(s)))s._modelViewMatrix.multiply(t.matrixWorldInverse,s.matrixWorld),z.render=!0;o=0;for(q=r.length;o<q;o++)z=r[o],z.render&&(s=z.object,z=z.buffer,v=s.material instanceof THREE.MeshFaceMaterial?s.material.materials[0]:s.material,w=0<s.geometry.morphTargets.length&&v.morphTargets,v=s instanceof THREE.SkinnedMesh&&v.skinning,w=s.customDepthMaterial?s.customDepthMaterial:v?w?f:e:w?d:c,z instanceof THREE.BufferGeometry?b.renderBufferDirect(t,l.__lights,null,w,z,s):b.renderBuffer(t,
l.__lights,null,w,z,s));r=l.__webglObjectsImmediate;o=0;for(q=r.length;o<q;o++)z=r[o],s=z.object,s.visible&&s.castShadow&&(s._modelViewMatrix.multiply(t.matrixWorldInverse,s.matrixWorld),b.renderImmediateObject(t,l.__lights,null,c,s))}n=b.getClearColor();p=b.getClearAlpha();a.clearColor(n.r,n.g,n.b,p);a.enable(a.BLEND);b.shadowMapCullFrontFaces&&a.cullFace(a.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;
...
THREE.TrackballControls=function(a,b){function c(a){h.enabled&&(window.removeEventListener("keydown",c),m=l,l===i.NONE&&(a.keyCode===h.keys[i.ROTATE]&&!h.noRotate?l=i.ROTATE:a.keyCode===h.keys[i.ZOOM]&&!h.noZoom?l=i.ZOOM:a.keyCode===h.keys[i.PAN]&&!h.noPan&&(l=i.PAN)))}function d(a){h.enabled&&(l===i.ROTATE&&!h.noRotate?o=h.getMouseProjectionOnBall(a.clientX,a.clientY):l===i.ZOOM&&!h.noZoom?t=h.getMouseOnScreen(a.clientX,a.clientY):l===i.PAN&&!h.noPan&&(z=h.getMouseOnScreen(a.clientX,a.clientY)))}
function e(a){h.enabled&&(a.preventDefault(),a.stopPropagation(),l=i.NONE,document.removeEventListener("mousemove",d),document.removeEventListener("mouseup",e))}function f(a){if(h.enabled){a.preventDefault();a.stopPropagation();var b=0;a.wheelDelta?b=a.wheelDelta/40:a.detail&&(b=-a.detail/3);q.y+=0.05*(1/b)}}function g(a){if(h.enabled)switch(a.preventDefault(),a.touches.length){case 1:p=o=h.getMouseProjectionOnBall(a.touches[0].pageX,a.touches[0].pageY);break;case 2:q=t=h.getMouseOnScreen(a.touches[0].pageX,
a.touches[0].pageY);break;case 3:s=z=h.getMouseOnScreen(a.touches[0].pageX,a.touches[0].pageY)}}THREE.EventTarget.call(this);var h=this,i={NONE:-1,ROTATE:0,ZOOM:1,PAN:2};this.object=a;this.domElement=void 0!==b?b:document;this.enabled=!0;this.screen={width:0,height:0,offsetLeft:0,offsetTop:0};this.radius=(this.screen.width+this.screen.height)/4;this.rotateSpeed=1;this.zoomSpeed=1.2;this.panSpeed=0.3;this.staticMoving=this.noPan=this.noZoom=this.noRotate=!1;this.dynamicDampingFactor=0.2;this.minDistance=
0;this.maxDistance=Infinity;this.keys=[65,83,68];this.target=new THREE.Vector3;var j=new THREE.Vector3,l=i.NONE,m=i.NONE,n=new THREE.Vector3,p=new THREE.Vector3,o=new THREE.Vector3,q=new THREE.Vector2,t=new THREE.Vector2,s=new THREE.Vector2,z=new THREE.Vector2,w={type:"change"};this.handleResize=function(){this.screen.width=window.innerWidth;this.screen.height=window.innerHeight;this.screen.offsetLeft=0;this.screen.offsetTop=0;this.radius=(this.screen.width+this.screen.height)/4};this.handleEvent=
...
d.addSelf(h.object.up.clone().crossSelf(n).setLength(c.x));d.addSelf(n.setLength(c.z));return d};this.rotateCamera=function(){var a=Math.acos(p.dot(o)/p.length()/o.length());if(a){var b=(new THREE.Vector3).cross(p,o).normalize(),c=new THREE.Quaternion,a=a*h.rotateSpeed;c.setFromAxisAngle(b,-a);c.multiplyVector3(n);c.multiplyVector3(h.object.up);c.multiplyVector3(o);h.staticMoving?p.copy(o):(c.setFromAxisAngle(b,a*(h.dynamicDampingFactor-1)),c.multiplyVector3(p))}};this.zoomCamera=function(){var a=
1+(t.y-q.y)*h.zoomSpeed;1!==a&&0<a&&(n.multiplyScalar(a),h.staticMoving?q.copy(t):q.y+=(t.y-q.y)*this.dynamicDampingFactor)};this.panCamera=function(){var a=z.clone().subSelf(s);if(a.lengthSq()){a.multiplyScalar(n.length()*h.panSpeed);var b=n.clone().crossSelf(h.object.up).setLength(a.x);b.addSelf(h.object.up.clone().setLength(a.y));h.object.position.addSelf(b);h.target.addSelf(b);h.staticMoving?s=z:s.addSelf(a.sub(z,s).multiplyScalar(h.dynamicDampingFactor))}};this.checkDistances=function(){if(!h.noZoom||
!h.noPan)h.object.position.lengthSq()>h.maxDistance*h.maxDistance&&h.object.position.setLength(h.maxDistance),n.lengthSq()<h.minDistance*h.minDistance&&h.object.position.add(h.target,n.setLength(h.minDistance))};this.update=function(){n.copy(h.object.position).subSelf(h.target);h.noRotate||h.rotateCamera();h.noZoom||h.zoomCamera();h.noPan||h.panCamera();h.object.position.add(h.target,n);h.checkDistances();h.object.lookAt(h.target);0<j.distanceToSquared(h.object.position)&&(h.dispatchEvent(w),j.copy(h.object.position))};
this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},!1);this.domElement.addEventListener("mousedown",function(a){h.enabled&&(a.preventDefault(),a.stopPropagation(),l===i.NONE&&(l=a.button),l===i.ROTATE&&!h.noRotate?p=o=h.getMouseProjectionOnBall(a.clientX,a.clientY):l===i.ZOOM&&!h.noZoom?q=t=h.getMouseOnScreen(a.clientX,a.clientY):l===i.PAN&&!h.noPan&&(s=z=h.getMouseOnScreen(a.clientX,a.clientY)),document.addEventListener("mousemove",d,!1),document.addEventListener("mouseup",
e,!1))},!1);this.domElement.addEventListener("mousewheel",f,!1);this.domElement.addEventListener("DOMMouseScroll",f,!1);this.domElement.addEventListener("touchstart",g,!1);this.domElement.addEventListener("touchend",g,!1);this.domElement.addEventListener("touchmove",function(a){if(h.enabled)switch(a.preventDefault(),a.touches.length){case 1:o=h.getMouseProjectionOnBall(a.touches[0].pageX,a.touches[0].pageY);break;case 2:t=h.getMouseOnScreen(a.touches[0].pageX,a.touches[0].pageY);break;case 3:z=h.getMouseOnScreen(a.touches[0].pageX,
a.touches[0].pageY)}},!1);window.addEventListener("keydown",c,!1);window.addEventListener("keyup",function(){h.enabled&&(l=m,window.addEventListener("keydown",c,!1))},!1);this.handleResize()};
