(function (require, $) {
    ...
    require(
        [
            ...
            'video/04_sign_language_control.js',
        ...
        function (
            VideoStorage, initialize, FocusGrabber, VideoAccessibleMenu,
            VideoSignLanguageControl,
            VideoControl, VideoFullScreen,
            ...
            window.Video = function (element) {
                var el = $(element).find('.video'),
                    ...
                    mainVideoModules = [FocusGrabber, VideoControl, VideoPlayPlaceholder,
                        ...
                        VideoQualityControl,
                        VideoSignLanguageControl,
                        VideoFullScreen, VideoCaption, VideoCommands, VideoContextMenu,
