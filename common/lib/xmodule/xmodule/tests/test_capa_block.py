...
from xmodule.capa_block import CapaModule, ComplexEncoder
...
class CapaModuleTest(unittest.TestCase):
    ...
    def test_check_problem_correct(self):
        ...
        with patch('capa.correctmap.CorrectMap.is_correct') as mock_is_correct, \
                patch('xmodule.capa_block.CapaModule.get_problem_html') as mock_html:
    ...
    def test_check_problem_closed(self):
        ...
        with patch('xmodule.capa_block.CapaModule.closed') as mock_closed:
    ...
    def test_reset_problem(self):
        ...
        with patch('xmodule.capa_block.CapaModule.get_problem_html') as mock_html:
