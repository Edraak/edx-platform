...
class VideoModule(VideoFields, VideoTranscriptsMixin, VideoStudentViewHandlers, XModule):
    ...
    js = {
        'js': [
            ...
            resource_string(module, 'js/src/video/00_sign_language_state.js'),
            ...
            resource_string(module, 'js/src/video/055_sign_language_control.js'),
    ...
    css = {'scss': [
        ...
        resource_string(module, 'css/video/video_popover.scss'),
    ]}
    ...
    def get_html(self):
        ...
        return self.system.render_template('video.html', {
            ...
            'non_sign_language_video_id': self.non_sign_language_video_id,
