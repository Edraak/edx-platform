...
from ../tests/video/test_studio_video_module import CMSVideoBaseTest
...
class VideoHandoutTest(CMSVideoBaseTest):
    ...
    def test_handout_uploads_correctly(self):
        ...
        """
        self.new_page("test handout uploads correctly")
        ...
        self.save_har("test_handout_uploads_correctly"")
    ...
    def test_handout_download_works_with_save(self):
        ...
        """
        self.new_page("test_handout_download_works_with_save")
        ...
        self.save_har("test_handout_download_works_with_save")
    ...
    def test_handout_download_works_wo_save(self):
        ...
        And I can download handout file in editor with mime type "application/pdf"
        """
        self.new_page("test_handout_download_works_wo_save")

        self._create_course_unit_with_handout('textbook.pdf', save_settings=False)

        self.assertEqual(self.video.download_handout('application/pdf', is_editor=True), (True, True))

        self.save_har("test_handout_download_works_wo_save")
    ...
    def test_handout_clearing_works_w_save(self):
        ...
        """
        self.new_page("test_handout_clearing_works_w_save")
        ...
        self.save_har("test_handout_clearing_works_w_save")
    ...
    def test_handout_clearing_works_wo_save(self):
        ...
        Then I do not see video button "handout"
        """
        self.new_page("test_handout_clearing_works_wo_save")
        ...
        self.save_har("test_handout_clearing_works_wo_save")
    ...
    def test_handout_replace_w_save(self):
        ...
        And I can download handout file with mime type "application/pdf"
        """
        self.new_page("test_handout_replace_w_save")
        ...
        self.save_har("test_handout_replace_w_save")
    ...
    def test_handout_replace_wo_save(self):
        ...
        And I can download handout file with mime type "application/pdf"
        """
        self.new_page("test_handout_replace_wo_save")
        ...
        self.save_har("test_handout_replace_wo_save")
    ...
    def test_handout_upload_and_clear_works(self):
        ...
        And I can download handout file with mime type "application/pdf"
        """
        self.new_page("test_upload_and_clear_works")
        ...
        self.save_har("test_upload_and_clear_works")
