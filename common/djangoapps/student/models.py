...
class UserProfile(models.Model):
    ...
    def has_registered(cls, user):
        """
        Handles django anonymous users.  SHOULD use this to test whether request.user is has registered,
        i.e. is not AnonymousUser and not nonregistered,
        instead of directly accessing user.profile.nonregistered,
        because if the user is AnonymousUser it won't have a profile.
        """
        return user.is_authenticated() and not user.profile.nonregistered
